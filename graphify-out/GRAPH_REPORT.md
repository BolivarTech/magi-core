...
## Corpus Check
- 186 files · ~349,922 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3604 nodes · 7988 edges · 429 communities (207 shown, 222 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 119 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6be22e86`
...
## Communities (429 total, 222 thin omitted)
...
### Community 4 - ".new"
Cohesion: 0.11
Nodes (50): a_completion_record_is_built_in_exactly_one_place(), a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet() (+42 more)

### Community 5 - "String"
Cohesion: 0.20
Nodes (12): CapturingMockProvider, contract_prompt(), Mode, Mutex, String, test_analyze_applies_mode_agnostic_override_to_melchior(), test_analyze_per_mode_override_supersedes_all_modes(), test_analyze_respects_prompts_dir_loaded_files() (+4 more)
...
Cohesion: 0.05
Nodes (78): AbortHandle, AgentOutput, ExternalErrorKind, ExtractionFailureCause, InputSize, a_crate_defect_records_nothing_because_its_report_will_not_exist(), a_mage_local_rotation_detail_says_what_happened_and_not_its_scope(), a_probe_declaring_another_model_is_named_not_rejected() (+70 more)
...
Cohesion: 0.09
Nodes (25): AgentFactory, Box, ComplexityGate, ConsensusConfig, ConsensusEngine, FallbackPool, Lineage, P (+17 more)
...
Cohesion: 0.22
Nodes (9): AsRef, Deref, the_preflight_stops_if_smoke_cargo_lock_is_not_actually_tracked(), fresh_temp_dir(), repo_where_the_negation_was_removed(), Path, Self, temp_root_with() (+1 more)
...
Cohesion: 0.08
Nodes (29): AtomicUsize, Mutex, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_cold_model_passes_on_the_second_probe_attempt(), an_endpoint_slow_every_time_still_reports_cannot_test(), AlwaysSlowStub, block_comment_depth_after(), BulkStub (+21 more)
...
### Community 275 - "run"
Cohesion: 0.16
Nodes (28): a_probe_that_is_slow_names_both_possible_causes(), a_rotation_candidate_the_backend_does_not_hold_is_refused_too(), a_seat_model_the_backend_does_not_hold_is_refused_before_any_scenario_runs(), audit_published_package(), check_lock_is_tracked(), check_seat_models(), check_workspace_isolation(), classify_probe_body() (+20 more)
...
Cohesion: 0.10
Nodes (42): Agent, BTreeMap, CompletionRecord, CrateDefectRecord, DispatchOutcome, Elapsed, ExtractionFailure, JoinError (+34 more)

### Community 354 - "run_against_a_hanging_backend_with_ceiling"
Cohesion: 0.25
Nodes (8): a_hanging_seat_degrades_the_run_within_the_given_ceiling(), report_with_one_failing_agent(), MagiReport, run_against_a_hanging_backend_with_ceiling(), test_a_2_2_0_report_without_the_field_still_deserializes(), test_counts_are_derivable_from_the_records(), test_the_section_attributes_cause_and_model_when_there_were_failures(), the_timeout_message_carries_the_configured_ceiling()

### Community 380 - "preflight.rs"
Cohesion: 0.09
Nodes (33): a_backend_holding_every_seat_model_passes_the_check(), a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_config_that_is_not_a_full_trio_is_rejected_as_a_config_fault(), a_config_with_no_fallbacks_is_a_config_fault_not_a_crate_verdict(), a_config_without_seats_is_rejected_by_name_in_the_config_step(), a_fallback_sharing_a_seats_lineage_is_rejected(), a_fallback_sharing_a_seats_model_is_rejected(), a_listing_larger_than_the_cap_is_not_held_in_memory() (+25 more)

### Community 381 - "AgentOutput"
Cohesion: 0.21
Nodes (7): AgentOutput, Finding, Into, String, Vec, test_finding_with_location_and_category(), Verdict

### Community 386 - "Report"
Cohesion: 0.16
Nodes (11): Assertion, ExitCode, a_verdict_about_the_crate_outranks_our_own_failure_to_certify(), AssertionRow, both_renderers_name_the_cap_that_was_exceeded_rather_than_an_overrun(), format_row(), Report, row_to_json() (+3 more)
...
### Community 414 - "Mode"
Cohesion: 0.38
Nodes (4): Mode, Display, Formatter, Result

### Community 430 - "PreflightError"
Cohesion: 0.14
Nodes (13): Announcement, no_backend_skips_the_backend_steps_and_nothing_else(), preflight_step_order(), PreflightError, Debug, Error, Formatter, Into (+5 more)
...
### Community 437 - "Self"
Cohesion: 0.12
Nodes (15): Formatter, Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), BudgetBearing, CompletionTelemetry, elided(), finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary() (+7 more)
...
- **Why does `ProviderError` connect `ProviderError` to `LlmProvider`, `Completion`, `rotation.rs`, `OllamaProvider`, `String`, `MagiError`, `HostedModel`, `ProviderResponse`, `openai_compat.rs`, `Self`, `ollama.rs`, `provider_url.rs`, `ProviderRequest`, `claude.rs`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `MagiError` connect `MagiError` to `String`, `prompts/mod.rs`, `consensus.rs`, `validate.rs`, `LlmProvider`, `ProviderError`, `MagiBuilder`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `stage_e1_run_ids()` connect `preflight.rs` to `runner.rs`, `RunId`, `.new`?**
