...
## Corpus Check
- 161 files · ~258,581 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2989 nodes · 6804 edges · 332 communities (186 shown, 146 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `021517c6`
...
## Communities (332 total, 146 thin omitted)

### Community 0 - "proxy.rs"
Cohesion: 0.09
Nodes (33): Box, Error, Infallible, Item, Send, a_backend_that_never_answers_is_cut_by_the_proxys_own_bound(), a_broken_response_read_is_not_answered_as_an_empty_success(), a_broken_response_read_is_not_recorded_as_an_empty_answer() (+25 more)
...
Cohesion: 0.07
Nodes (46): CompletionConfig, Default, Beh, build_oversized_case(), build_schema_local_case(), build_trio_with_caspar(), build_two_5xx_with_local_fallbacks(), build_two_external_failing_no_fallback() (+38 more)
...
Cohesion: 0.06
Nodes (54): I, PathBuf, a_file_on_disk_that_nobody_declares_is_an_orphan_too(), a_fixture_whose_hash_changed_is_rejected(), a_missing_fixtures_directory_is_reported_not_silently_clean(), a_nested_corpus_is_refused_because_the_walk_does_not_recurse(), a_readable_entry_is_still_crossed_against_the_manifest(), a_verified_by_naming_a_live_scenario_is_accepted() (+46 more)
...
### Community 76 - "e1.rs"
Cohesion: 0.05
Nodes (112): sha256_hex(), assert_that(), Assertion, RunContext, a_fired_injection(), a_typed_crate_failure_is_a_verdict_about_the_crate(), an_unclassified_failure_is_read_as_the_crate_s(), analyze_produced_a_report() (+104 more)
...
Cohesion: 0.07
Nodes (21): BTreeSet, F, a_panic_inside_a_run_is_caught_and_attributed_instead_of_killing_the_harness(), a_run_that_finishes_is_returned_untouched(), classify_panic(), crate_under_test_packages(), every_harness_only_dep_is_ABSENT_from_the_crate_under_tests_own_graph(), exit_code() (+13 more)
...
Cohesion: 0.10
Nodes (29): Config, Debug, Display, Formatter, Into, Result, ConfigError, a_probe_answered_with_404_names_both_possible_causes_too() (+21 more)
...
Cohesion: 0.06
Nodes (47): Default, Drop, Duration, FnOnce, Path, Self, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads() (+39 more)

### Community 200 - "main.rs"
Cohesion: 0.07
Nodes (52): AssertionRow, BuildOutcome, CostLedger, CycleRun, Output, RunContext, RunId, RunResult (+44 more)
...
Cohesion: 0.10
Nodes (22): AtomicBool, B, Bytes, X, Client, HeaderMap, Incoming, Option (+14 more)

### Community 239 - "[1.1.0] - 2026-05-25"
Cohesion: 0.67
Nodes (3): [1.1.0] - 2026-05-25, Added, Notes

### Community 243 - "ReportConfig"
Cohesion: 0.16
...
### Community 288 - "redaction_negative.rs"
Cohesion: 0.37
...
- **Why does `LlmProvider` connect `LlmProvider` to `ProviderError`, `.analyze`, `HostedModel`, `MockProvider`, `MockProbe`, `claude.rs`, `claude_cli.rs`, `test_support.rs`, `basic_analysis.rs`, `ollama.rs`, `MagiBuilder`, `.new`, `Magi`, `RetryAfterProvider`, `.complete`, `SlowFailingProvider`, `ProviderProbe`, `provider.rs`, `rotation.rs`, `Result`, `openai_compat.rs`, `.new`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `ProviderRequest` connect `ProviderRequest` to `Self`, `ProviderResponse`, `provider_url.rs`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `env_scoped()` connect `config.rs` to `Self`?**
