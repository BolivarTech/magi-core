...
## Corpus Check
- 186 files · ~354,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3617 nodes · 8021 edges · 435 communities (211 shown, 224 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 119 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d34e1946`
...
## Communities (435 total, 224 thin omitted)
...
Cohesion: 0.11
Nodes (16): SessionFacts, BackendNeed, cannot_test_is_a_skip_with_a_reason_not_a_silent_empty_result(), classify_error(), ErrorClass, render_error(), MagiError, shipped_timings() (+8 more)
...
### Community 22 - "Self"
Cohesion: 0.14
Nodes (15): Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), CompletionTelemetry, elided(), every_contract_variant_has_its_own_retry_class(), finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary(), FinishReason (+7 more)
...
### Community 177 - "RunId"
Cohesion: 0.18
Nodes (15): Config, PayloadError, RunId, run_label(), build_with_absurd_timings(), chat_request(), probe_is_in_scope(), probe_window() (+7 more)
...
### Community 266 - "AssertionRow"
Cohesion: 0.25
Nodes (7): Assertion, AssertionRow, both_renderers_name_the_cap_that_was_exceeded_rather_than_an_overrun(), format_row(), row_to_json(), Vec, state_marker()
...
Cohesion: 0.14
Nodes (23): Fallback, Injection, Payload, RequestRecord, RunOutcome, Seat, runner::Runner, a_timed_out_run_reports_its_cap_verbatim() (+15 more)
...
### Community 313 - "CertificateFacts"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (5): Into, an_assertion_that_could_not_be_tested_carries_its_reason(), Self, String, RunContext<'static>

### Community 347 - "Completion"
Cohesion: 0.09
Nodes (18): Result, Formatter, From, Ok, S, Result, classify(), Completion (+10 more)

### Community 349 - "dedup_key"
Cohesion: 0.33
...
### Community 354 - "empty_completion_remedy"
Cohesion: 0.50
Nodes (3): empty_completion_remedy(), Option, BudgetBearing
...
- **Why does `ProviderError` connect `ProviderError` to `empty_completion_remedy`, `OllamaProvider`, `LlmProvider`, `ResponseContractCause`, `HostedModel`, `rotation.rs`, `MagiError`, `error.rs`, `ProviderResponse`, `openai_compat.rs`, `ollama.rs`, `Self`, `provider_url.rs`, `ProviderRequest`, `claude.rs`, `Completion`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `MagiError` connect `MagiError` to `prompts/mod.rs`, `consensus.rs`, `empty_completion_remedy`, `validate.rs`, `LlmProvider`, `ProviderError`, `error.rs`, `validate_prompt_for`, `MagiBuilder`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `LlmProvider` connect `LlmProvider` to `.new`, `provider.rs`, `HostedModel`, `.new`, `claude_cli.rs`, `basic_analysis.rs`, `dispatch_one_agent_rotating`, `openai_compat.rs`, `MockProvider`, `MagiBuilder`, `proxy.rs`, `claude.rs`, `Error`, `Completion`?**
