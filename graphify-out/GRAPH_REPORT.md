...
## Corpus Check
- 42 files · ~102,978 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1572 nodes · 3978 edges · 106 communities (71 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `853c4287`
...
Cohesion: 0.11
Nodes (51): dispatch_one_agent(), echoed_example_response(), magi_error_for(), mock_agent_json(), mock_agent_object(), parse_agent_response(), parse_and_validate(), parse_validate_and_check() (+43 more)

### Community 1 - "reporting.rs"
Cohesion: 0.06
Nodes (82): Condition, ConsensusResult, DedupFinding, Dissent, Option, String, Vec, cause_label() (+74 more)
...
### Community 23 - ".cmp"
Cohesion: 0.12
Nodes (15): ComplexityGate, PathBuf, MagiBuilder, MagiConfig, Box, Default, Duration, P (+7 more)
...
Cohesion: 0.12
Nodes (27): AbortHandle, DispatchOutcome, JoinError, AbortGuard, attempt_model(), CapturingMockProvider, collect_probe_targets(), default_rotations() (+19 more)
...
Cohesion: 0.18
Nodes (11): [0.1.2] - 2026-04-05, [0.3.1] - 2026-04-19, [1.0.1] - 2026-05-25, [2.2.0] - 2026-07-27, Changed, Changelog, Fixed, Fixed (+3 more)
...
### Community 51 - "SlowFailingProvider"
Cohesion: 0.40
...
Cohesion: 0.06
Nodes (57): AtomicU32, RetryClass, AbandonReason, ProviderError, Duration, Instant, String, classify() (+49 more)

### Community 76 - "[1.1.0] - 2026-05-25"
Cohesion: 0.67
...
## Knowledge Gaps
- **166 isolated node(s):** `check_r0.sh script`, `Fixed`, `Changed`, `Fixed`, `Changed` (+161 more)
...
- **Why does `ProviderError` connect `MockProvider` to `[0.3.0] - 2026-04-18`, `validate.rs`, `Finding`, `ProviderError`, `RoutingMockProvider`, `openai_compat.rs`, `claude.rs`, `error.rs`, `claude_cli.rs`, `String`, `error.rs`, `finding_id.rs`, `LlmProvider`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `orchestrator.rs`, `[0.3.0] - 2026-04-18`, `consensus.rs`, `reporting.rs`, `Finding`, `5. Data Schema and Consensus Protocol`, `[1.1.1] - 2026-07-17`, `user_prompt.rs`, `MockProvider`, `error.rs`, `Lineage`, `dispatch_one_agent`, `LlmProvider`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `LlmProvider` connect `[0.3.0] - 2026-04-18` to `Finding`, `ProviderError`, `RoutingMockProvider`, `openai_compat.rs`, `claude.rs`, `error.rs`, `MockProvider`, `claude_cli.rs`, `String`, `FallbackPool`, `RoutingMockProvider`, `prelude.rs`, `finding_id.rs`, `.cmp`, `LlmProvider`?**
