# Graph Report - MAGI-Core  (2026-09-09)

## Corpus Check
- 198 files · ~420,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3661 nodes · 8670 edges · 263 communities (219 shown, 44 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 164 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a5f3df6`
...
1. `AgentName` - 87 edges
2. `blank_ctx()` - 60 edges
3. `LlmProvider` - 55 edges
4. `RunContext` - 53 edges
5. `MagiError` - 47 edges
6. `Completion` - 46 edges
7. `MagiBuilder` - 43 edges
8. `Assertion` - 41 edges
9. `CompletionConfig` - 40 edges
10. `Magi` - 39 edges
...
## Communities (263 total, 44 thin omitted)
...
### Community 1 - "RunResult"
Cohesion: 0.14
Nodes (21): Fallback, Seat, RunOutcome, attempts_for(), build_magi_against(), build_with_absurd_timings(), ErosionProbe, injected_agent() (+13 more)
...
### Community 5 - "String"
Cohesion: 0.15
Nodes (24): a_probe_that_is_slow_names_both_possible_causes(), audit_published_package(), check_lock_is_tracked(), check_workspace_isolation(), classify_probe_body(), harness_files_in_listing(), Inconclusive, listed_models() (+16 more)

### Community 6 - "agent.rs"
Cohesion: 0.09
Nodes (33): agent_files_covers_every_agent_and_mode_with_distinct_names(), AgentFactory, lookup(), lookup_resolves_covered_pairs_and_rejects_uncovered_ones(), MockProvider, Arc, AtomicUsize, BTreeMap (+25 more)
...
### Community 11 - ".new"
Cohesion: 0.13
Nodes (39): a_529_is_retried_and_the_second_attempt_succeeds(), a_limited_class_stops_at_its_own_count_not_at_max_retries(), a_mage_local_class_survives_the_attempt_cap_exit_too(), a_mage_local_class_survives_the_retry_loop_unwrapped(), a_present_retry_after_meets_the_attempt_cap_for_a_configured_http_class(), a_refused_redirect_is_mage_local_and_never_retried(), a_retry_after_that_is_too_long_abandons_with_the_incremented_count(), a_run_wide_class_still_comes_out_wrapped() (+31 more)
...
Cohesion: 0.15
Nodes (26): a_file_on_disk_that_nobody_declares_is_an_orphan_too(), a_fixture_whose_hash_changed_is_rejected(), a_manifest_path_that_escapes_the_corpus_is_refused(), a_missing_fixtures_directory_is_reported_not_silently_clean(), a_nested_corpus_is_refused_because_the_walk_does_not_recurse(), a_readable_entry_is_still_crossed_against_the_manifest(), a_sync_that_cannot_finish_leaves_the_tracked_manifest_alone(), a_verified_by_naming_a_live_scenario_is_accepted() (+18 more)

### Community 19 - "ProviderError"
Cohesion: 0.10
Nodes (22): Ok, S, Serialize, cause_chain(), cause_chain_skips_the_top_level_error(), classify(), client_build_error(), FailingProvider (+14 more)
...
Cohesion: 0.10
Nodes (16): AtomicU32, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), BudgetBearing, Completion, CompletionTelemetry, every_contract_variant_has_its_own_retry_class(), http(), MockProvider (+8 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.08
Nodes (27): ComplexityGate, a_hanging_seat_degrades_the_run_within_the_given_ceiling(), contract_prompt(), MagiBuilder, Box, P, PathBuf, Self (+19 more)

### Community 24 - "proxy.rs"
Cohesion: 0.05
Nodes (61): B, Bytes, HeaderMap, Incoming, Infallible, Item, ProxyBody, a_backend_that_never_answers_is_cut_by_the_proxys_own_bound() (+53 more)

### Community 25 - "Manifest"
Cohesion: 0.15
Nodes (12): an_entry_that_cannot_be_read_is_reported_not_silently_dropped(), FixtureAudit, FixtureEntry, FixtureSummary, Manifest, BTreeSet, I, Option (+4 more)
...
Cohesion: 0.05
Nodes (19): Fn, extract(), is_marker_line(), locate(), locate_block(), normalize_line(), Cow, Display (+11 more)
...
Cohesion: 0.15
Nodes (13): [0.1.2] - 2026-04-05, [1.1.1] - 2026-07-17, [2.2.0] - 2026-07-27, [3.2.0] - 2026-08-10, [4.1.0] - Unreleased, Added, Changed, Changed (+5 more)

### Community 40 - "RequestRecord"
Cohesion: 0.23
Nodes (12): RequestRecord, sha256_hex(), answered_probes(), record(), recorded_response(), s2b_fails_when_the_recorded_request_body_hash_disagrees(), s2b_fails_when_the_relayed_status_differs_from_the_one_the_backend_gave(), s2b_passes_when_both_hashes_and_the_status_match() (+4 more)
...
### Community 44 - "s4_rotation_and_its_cause"
Cohesion: 0.19
...
### Community 45 - "basic_analysis.rs"
Cohesion: 0.29
...
Cohesion: 0.05
Nodes (86): a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_empty_pool_eligibility_is_still_written_to_the_wire(), an_exceeded_run_gains_exactly_one_section_naming_both_numbers(), an_older_report_without_the_field_still_deserializes() (+78 more)
...
Cohesion: 0.10
Nodes (17): SessionFacts, a_timed_out_run_reports_its_cap_verbatim(), BackendNeed, cannot_test_is_a_skip_with_a_reason_not_a_silent_empty_result(), classify_error(), ErrorClass, Scenario, shipped_timings() (+9 more)

### Community 69 - "LineageRegistry"
Cohesion: 0.11
Nodes (17): AgentSlotGuard, CrateDefectRecord, LineageRegistry, reg(), RegistryInner, Arc, Drop, Mutex (+9 more)
...
### Community 75 - ".new"
Cohesion: 0.26
Nodes (18): a_caller_holding_real_seat_state_produces_the_three_mid_run_causes(), a_seat_with_no_candidates_gets_an_empty_entry_not_a_missing_one(), a_spent_rotation_budget_is_reported_rather_than_read_as_eligible(), ActiveEntry, an_unmeasured_candidate_under_a_strict_guard_says_so(), cand(), EligibilityInputs, empty_wr() (+10 more)

### Community 76 - ".build"
Cohesion: 0.10
Nodes (45): a_completion_that_failed_is_recorded_too(), a_mage_local_failure_does_not_condemn_the_lineage_for_the_other_seats(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet() (+37 more)

### Community 78 - "RunId"
Cohesion: 0.25
Nodes (8): RunId, run_with(), chat_request(), probe_is_in_scope(), probe_window(), Error, show_request(), the_transparency_probe_gives_up_instead_of_waiting_forever()

### Community 80 - "Config"
Cohesion: 0.16
Nodes (14): Config, Duration, a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_listing_larger_than_the_cap_is_not_held_in_memory(), PreflightError, raise_proxy(), Display, Error (+6 more)
...
### Community 83 - "pool"
Cohesion: 0.23
Nodes (13): ae(), policy(), pool(), test_claim_next_none_leaves_registry_intact(), test_concurrent_claims_never_double_reserve_stress(), test_lineage_from_owned_string_is_owned(), test_lineage_from_static_is_borrowed_zero_alloc(), test_max_rotations_gate() (+5 more)

### Community 84 - "Announcement"
Cohesion: 0.20
...
Cohesion: 0.36
Nodes (11): RunContext, f_scenarios(), no_timings_skips_instead_of_passing(), Vec, s_f1(), s_f2a(), s_f2b(), s_f3() (+3 more)

### Community 90 - "e1.rs"
Cohesion: 0.08
Nodes (53): a_typed_crate_failure_is_a_verdict_about_the_crate(), an_unclassified_failure_is_read_as_the_crate_s(), blank_ctx(), e1_contains_exactly_the_scenarios_valid_against_3_2_0(), e1_scenarios(), preflight_error_for_stage(), Result, Vec (+45 more)
...
### Community 95 - "TempDir"
Cohesion: 0.15
Nodes (14): AsRef, Deref, the_startup_sweep_removes_only_temps_whose_pid_is_dead(), fresh_temp_dir(), is_privilege_refusal(), make_symlink(), repo_where_the_negation_was_removed(), Drop (+6 more)

### Community 96 - "ProviderError"
Cohesion: 0.17
Nodes (16): all_cases(), all_errors(), an_oversized_response_routes_to_its_own_mage_local_outcome(), Condemnation, crate_defect_of(), each_contract_variant_gets_the_consequence_the_spec_assigned(), enumerated(), every_external_shape_routes_to_its_own_mage_local_outcome() (+8 more)

### Community 97 - "MagiReport"
Cohesion: 0.24
Nodes (11): s15_four_assertions(), e_scenarios(), no_report_skips_instead_of_passing(), report_with(), Vec, s_e2_fails_when_nothing_was_ruled_out(), s_e2_why_a_candidate_was_not_eligible(), s_e3_all_failing_conditions() (+3 more)

### Community 98 - "CompletionConfig"
Cohesion: 0.09
Nodes (13): describe(), main(), MinimalProvider, MyBackend, ProviderError, Result, String, AlwaysFailsExternally (+5 more)
...
### Community 100 - "ResponseContractCause"
Cohesion: 0.40
Nodes (4): ResponseContractCause, Display, Formatter, Result

### Community 101 - "compose_transport_message"
Cohesion: 0.11
...
### Community 108 - "[0.3.1] - 2026-04-19"
Cohesion: 0.67
Nodes (3): [0.3.1] - 2026-04-19, Fixed, Yanked

### Community 109 - "ProviderProbe"
Cohesion: 0.11
Nodes (12): Barrier, FailingProbe, MockProbe, MockProvider, OverlapProbe, ProviderProbe, AtomicUsize, Formatter (+4 more)
...
### Community 132 - "Finding"
Cohesion: 0.17
Nodes (11): Ord, Ordering, PartialOrd, Finding, Display, Into, Option, Self (+3 more)

### Community 133 - "[1.0.1] - 2026-05-25"
Cohesion: 0.67
Nodes (3): [1.0.1] - 2026-05-25, Fixed, Internal

### Community 134 - "testkit.rs"
Cohesion: 0.09
Nodes (27): a_backend_that_does_not_hold_the_probe_model_is_INCONCLUSIVE_not_clear(), a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_cold_model_passes_on_the_second_probe_attempt(), AlwaysSlowStub, block_comment_depth_after(), BulkStub, EchoServer, ListingStub (+19 more)

### Community 137 - "String"
Cohesion: 0.50
Nodes (3): ProviderUrl, redacted(), String

### Community 138 - "abandon"
Cohesion: 0.17
...
### Community 144 - "[3.0.2] - 2026-07-30"
Cohesion: 0.67
...
### Community 166 - "MAGI System — Complete Technical Documentation"
Cohesion: 0.29
...
### Community 173 - "[3.0.0] - 2026-07-30"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (51): Deserialize, FnOnce, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused(), a_file_that_omits_seats_and_fallbacks_gets_the_built_in_ones(), a_file_value_an_override_rescues_is_judged_on_the_final_set_not_the_file_alone(), a_set_of_overrides_that_is_still_illegal_at_the_end_is_refused() (+43 more)

### Community 197 - "ProviderResponse"
Cohesion: 0.16
Nodes (9): X, ProviderError, Result, X, ProviderResponse, push_within_cap(), Option, Response (+1 more)

### Community 199 - "2. Translation to the Software Engineering Domain"
Cohesion: 0.50
...
### Community 200 - "s15_inconclusive"
Cohesion: 0.39
Nodes (8): render_combinations(), Into, Option, String, s15_inconclusive(), s15_skips(), why_the_forced_failure_cannot_be_read(), why_the_wire_cannot_answer()
...
### Community 218 - "3. The Three Agents in Detail"
Cohesion: 0.50
...
### Community 221 - "6. Modes of Operation"
Cohesion: 0.50
...
### Community 228 - "[1.1.0] - 2026-05-25"
Cohesion: 0.67
...
### Community 238 - "RetryConfig"
Cohesion: 0.08
Nodes (12): MockProvider, RetryClass, AlwaysFails, attempts_for(), RetryConfig, RetryProvider, Arc, AtomicUsize (+4 more)
...
### Community 258 - ".probe"
Cohesion: 0.33
Nodes (6): an_endpoint_slow_every_time_still_reports_cannot_test(), the_backend_step_and_the_probe_step_ask_different_questions(), the_contention_probe_sends_a_real_completion_not_a_manifest_listing(), the_window_bound_has_one_entry_per_request_the_preflight_makes(), stub_that_is_always_slow(), stub_that_records_requests()

### Community 260 - "AgentOutput"
Cohesion: 0.23
Nodes (5): AgentOutput, Formatter, Result, Vec, Verdict

### Community 266 - ".render_human"
Cohesion: 0.20
...
### Community 267 - "[2.1.0] - 2026-07-27"
Cohesion: 0.67
...
Cohesion: 0.09
Nodes (14): CandidateEligibility, extract_item(), IneligibilityCause, strict_guard_is_inert(), test_active_unverifiable_digest_does_not_block_rotation(), test_calling_agent_excluded_from_digest_check(), test_candidate_without_digest_is_accepted_trusting_lineage(), test_lineage_ord_for_btree_keys() (+6 more)

### Community 283 - "s15_degradation_is_honest"
Cohesion: 0.31
...
### Community 292 - "MagiConfig"
Cohesion: 0.33
Nodes (7): exceeds(), MagiConfig, measure_input(), Default, the_reported_flag_always_agrees_with_the_reported_count(), warn_threshold_is_unreachable(), estimate_tokens()
...
Cohesion: 0.08
Nodes (46): AbortHandle, DispatchOutcome, JoinError, Agent, MagiError, From, a_mage_local_rotation_detail_says_what_happened_and_not_its_scope(), AbortGuard (+38 more)
...
## Knowledge Gaps
- **226 isolated node(s):** `magi-core`, `check_packaged_consumer.sh script`, `check_r0.sh script`, `ProviderError`, `ProviderError` (+221 more)
...
- **Why does `AgentName` connect `AgentName` to `RunResult`, `consensus.rs`, `orchestrator.rs`, `Finding`, `agent.rs`, `schema.rs`, `AgentOutput`, `MagiBuilder`, `rotation.rs`, `reporting.rs`, `.new`, `prompts/mod.rs`, `config.rs`, `LineageRegistry`, `.new`, `.build`, `String`, `test_support.rs`, `RunContext`, `ProviderError`, `MagiReport`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `Config` connect `Config` to `RunResult`, `config.rs`, `String`, `runner.rs`, `RunId`, `.new`, `preflight.rs`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `RunId` connect `RunId` to `report.rs`, `RunResult`, `config.rs`, `runner.rs`, `main.rs`, `Config`, `AssertionRow`, `Report`, `RunContext`, `e1.rs`, `preflight.rs`, `.skip`?**
...
- **Should `RunResult` be split into smaller, more focused modules?**
