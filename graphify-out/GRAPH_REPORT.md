# Graph Report - MAGI-Core  (2026-09-06)

## Corpus Check
- 193 files · ~393,038 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3499 nodes · 8233 edges · 259 communities (215 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17411993`
...
### Community 9 - "Result"
Cohesion: 0.10
Nodes (20): Elapsed, a_crate_defect_records_nothing_because_its_report_will_not_exist(), a_mage_local_failure_does_not_condemn_the_lineage_for_the_other_seats(), a_timed_out_attempt_is_recorded_with_nothing_measured(), an_oversized_response_routes_to_its_own_mage_local_outcome(), crate_defect_of(), each_contract_variant_gets_the_consequence_the_spec_assigned(), every_external_shape_routes_to_its_own_mage_local_outcome() (+12 more)
...
### Community 17 - ".new"
Cohesion: 0.09
Nodes (39): AtomicU32, Ok, S, a_limited_class_stops_at_its_own_count_not_at_max_retries(), a_present_retry_after_meets_the_attempt_cap_for_a_configured_http_class(), a_refused_redirect_is_mage_local_and_never_retried(), completion_new_takes_only_the_mandatory_field(), MockProvider (+31 more)
...
Cohesion: 0.14
Nodes (14): ComplexityGate, MagiBuilder, Box, P, PathBuf, Self, Send, test_either_registration_door_produces_equal_builder_state() (+6 more)
...
Cohesion: 0.14
Nodes (30): assert_that(), Assertion, RunContext, analyze_produced_a_report(), s15_four_assertions(), s16_no_trace_left_in_the_repo(), r17_the_prompt_is_large_in_tokens(), Vec (+22 more)
...
Cohesion: 0.10
Nodes (19): SessionFacts, a_timed_out_run_reports_its_cap_verbatim(), BackendNeed, build_magi_against(), cannot_test_is_a_skip_with_a_reason_not_a_silent_empty_result(), classify_error(), ErrorClass, ProviderKind (+11 more)

### Community 69 - "Duration"
Cohesion: 0.23
Nodes (10): build_with_absurd_timings(), chat_request(), probe_is_in_scope(), probe_window(), Duration, Error, Path, Result (+2 more)

### Community 70 - "main.rs"
Cohesion: 0.10
Nodes (26): a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero(), a_run_that_could_not_start_is_never_a_verdict_about_the_crate(), a_scenario_filtered_out_by_no_backend_is_OUT_OF_SCOPE_not_omitted(), a_scenario_reading_one_run_never_sees_ANOTHER_runs_records(), absent_context(), dispatch_measured(), dispatching_alone_cannot_produce_a_receipt_the_estimate_never_preceded() (+18 more)

### Community 72 - ".render_human"
Cohesion: 0.20
...
### Community 75 - "digest_case"
Cohesion: 0.13
Nodes (28): ae(), AgentRotationState, cap(), caps_map(), digest_case(), digest_case_self(), digest_case_two_active(), policy() (+20 more)

### Community 76 - ".build"
Cohesion: 0.09
Nodes (51): a_completion_record_is_built_in_exactly_one_place(), a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), contract_prompt(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance() (+43 more)

### Community 78 - "write_and_verify_certificate_in"
Cohesion: 0.40
...
### Community 87 - "build_with"
Cohesion: 0.27
Nodes (8): a_hanging_seat_degrades_the_run_within_the_given_ceiling(), build_with(), build_with_honours_the_three_values_it_takes(), it_never_returns_err_no_matter_how_absurd_the_configuration(), Duration, run_against_a_hanging_backend_with_ceiling(), the_timeout_message_carries_the_configured_ceiling(), the_worst_case_is_per_seat_and_never_multiplies_by_the_trio()

### Community 88 - "Severity"
Cohesion: 0.24
Nodes (6): Ord, PartialOrd, Display, Formatter, Result, Severity

### Community 90 - "s2b_the_proxy_is_transparent"
Cohesion: 0.33
...
### Community 164 - "Completion"
Cohesion: 0.13
Nodes (11): AlwaysFailsExternally, ProviderError, Result, ProviderError, Result, Completion, CompletionConfig, production_half() (+3 more)
...
### Community 227 - "[1.0.1] - 2026-05-25"
Cohesion: 0.67
...
### Community 235 - "[3.0.2] - 2026-07-30"
Cohesion: 0.67
...
### Community 275 - "RunResult"
Cohesion: 0.23
Nodes (13): RunOutcome, attempts_for(), ErosionProbe, injected_agent(), render_error(), Option, String, Vec (+5 more)
...
Cohesion: 0.12
Nodes (11): cause_chain(), cause_chain_skips_the_top_level_error(), client_build_error(), FailingProvider, is_retryable(), AtomicUsize, Duration, Error (+3 more)

### Community 283 - "e1.rs"
Cohesion: 0.08
Nodes (52): a_typed_crate_failure_is_a_verdict_about_the_crate(), an_unclassified_failure_is_read_as_the_crate_s(), blank_ctx(), e1_contains_exactly_the_scenarios_valid_against_3_2_0(), e1_scenarios(), preflight_error_for_stage(), Result, s14_does_not_blame_the_crate_for_a_config_fault_of_another_shape() (+44 more)
...
Cohesion: 0.09
Nodes (41): AbortHandle, DispatchOutcome, JoinError, ExternalErrorKind, MagiError, From, a_crate_defect_outranks_a_simultaneous_endpoint_outage(), a_mage_local_rotation_detail_says_what_happened_and_not_its_scope() (+33 more)
...
### Community 437 - "RetryConfig"
Cohesion: 0.20
Nodes (8): RetryClass, attempts_for(), classify(), every_contract_variant_has_its_own_retry_class(), RetryAfterProvider, RetryConfig, Default, Vec
...
- **Why does `AgentName` connect `AgentName` to `test_support.rs`, `consensus.rs`, `orchestrator.rs`, `LlmProvider`, `schema.rs`, `Result`, `RunResult`, `MagiBuilder`, `rotation.rs`, `.new`, `embedded_prompt_for`, `RunContext`, `prompts/mod.rs`, `.cmp`, `config.rs`, `.build`, `MagiError`, `Severity`, `LineageRegistry`, `ReportFormatter`, `String`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Config` connect `Config` to `config.rs`, `run`, `runner.rs`, `Duration`, `preflight.rs`, `RunResult`, `.new`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `MagiError` connect `MagiError` to `AgentName`, `prompts/mod.rs`, `consensus.rs`, `validate.rs`, `runner.rs`, `orchestrator.rs`, `LlmProvider`, `build_user_prompt`, `user_prompt.rs`, `.build`, `error.rs`, `Lineage`, `RunResult`, `body_bounds.rs`, `build_with`, `MagiBuilder`?**
