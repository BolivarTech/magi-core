...
## Corpus Check
- 177 files · ~315,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3410 nodes · 7634 edges · 419 communities (197 shown, 222 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b9c3bd8`
...
## Communities (419 total, 222 thin omitted)

### Community 0 - "test_support.rs"
Cohesion: 0.06
Nodes (51): AgentName, ExtractionFailureCause, HashMap, Magi, Beh, build_oversized_case(), build_schema_local_case(), build_trio_with_caspar() (+43 more)
...
Cohesion: 0.07
Nodes (3): test_validate_accepts_confidence_at_boundaries(), test_validate_rejects_infinity_confidence(), test_validator_new_creates_with_default_limits()

### Community 4 - ".analyze"
Cohesion: 0.09
Nodes (40): a_completion_that_failed_is_recorded_too(), contract_prompt(), test_a_clean_run_adds_no_section_to_the_human_report(), test_analyze_all_agents_fail_returns_insufficient_agents(), test_analyze_applies_mode_agnostic_override_to_melchior(), test_analyze_input_too_large_rejects_without_launching_agents(), test_analyze_no_retry_on_timeout_keeps_retried_empty(), test_analyze_one_agent_bad_json_degrades_gracefully() (+32 more)

### Community 5 - "Self"
Cohesion: 0.09
Nodes (17): AtomicU32, Deserialize, Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), CompletionTelemetry, finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary(), FinishReason (+9 more)
...
Cohesion: 0.09
Nodes (25): a_native_empty_without_the_footprint_falls_back_to_empty_completion(), done_reason_body(), into_completion_carries_a_measured_reasoning_trace_when_present(), into_completion_carries_the_telemetry_of_a_real_success(), is_crate_defect(), native_empty_with_counters(), native_error(), native_error_falls_back_to_the_raw_body_when_it_does_not_parse_as_native_error() (+17 more)
...
Cohesion: 0.06
Nodes (46): Config, Duration, Fallback, Injection, Payload, PayloadError, ReasoningControl, RequestRecord (+38 more)

### Community 18 - "orchestrator.rs"
Cohesion: 0.08
Nodes (63): AbortHandle, Elapsed, a_crate_defect_records_nothing_because_its_report_will_not_exist(), a_threshold_is_unreachable_when_the_smallest_warning_input_is_already_rejected(), a_threshold_that_can_never_fire_is_detected(), a_timed_out_attempt_is_recorded_with_nothing_measured(), a_zero_threshold_warns_always_and_does_not_disable(), an_empty_input_never_exceeds_even_a_zero_threshold() (+55 more)
...
### Community 21 - ".builder"
Cohesion: 0.13
Nodes (22): FallbackPool, ProviderProbe, a_completion_record_is_built_in_exactly_one_place(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_probe_declaring_another_model_is_named_not_rejected(), a_probe_declaring_its_own_model_is_quiet(), a_probe_that_claims_nothing_is_checked_against_nothing(), a_run_with_no_cuts_still_records_one_entry_per_completion() (+14 more)

### Community 22 - "Arc"
Cohesion: 0.12
Nodes (40): Agent, AgentFactory, Arc, Completion, CompletionConfig, ConsensusEngine, DispatchOutcome, JoinError (+32 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.11
Nodes (20): Box, ComplexityGate, ConsensusConfig, Lineage, LlmProvider, P, RngLike, Send (+12 more)
...
Cohesion: 0.22
Nodes (11): CrateDefectRecord, ExternalErrorKind, ProviderError, RotationKind, an_oversized_response_routes_to_its_own_mage_local_outcome(), crate_defect_of(), each_contract_variant_gets_the_consequence_the_spec_assigned(), every_external_shape_routes_to_its_own_mage_local_outcome() (+3 more)
...
### Community 43 - "e2.rs"
Cohesion: 0.08
Nodes (53): Assertion, CompletionRecord, MagiReport, RunContext, Scenario, assert_that(), content_failure_detail(), e2_scenarios() (+45 more)

### Community 44 - ".new_checked"
Cohesion: 0.17
Nodes (9): Display, Formatter, ResponseContractCause, Result, Result, test_new_checked_accepts_all_ascii_titles(), test_new_checked_rejects_banner_width_too_small(), test_new_checked_rejects_non_ascii_display_name() (+1 more)
...
Cohesion: 0.07
Nodes (12): a_message_of_exactly_the_cap_is_kept_whole(), a_short_external_message_survives_untouched(), AbandonReason, an_oversized_external_message_is_cut_and_says_so(), external_message(), ExternalErrorKind, Duration, String (+4 more)
...
### Community 67 - ".new"
Cohesion: 0.16
Nodes (26): finding_with_title(), output_with_confidence(), output_with_findings(), Vec, test_validate_accepts_finding_with_normal_title(), test_validate_accepts_valid_agent_output(), test_validate_mut_collapses_control_whitespace_in_titles(), test_validate_mut_preserves_order_of_findings() (+18 more)
...
### Community 69 - "RetryConfig"
Cohesion: 0.14
Nodes (8): Default, RetryClass, classify(), every_contract_variant_has_its_own_retry_class(), RetryConfig, RetryProvider, Duration, SlowFailingProvider

### Community 70 - "main.rs"
Cohesion: 0.08
Nodes (44): AssertionRow, CostLedger, CycleRun, I, Output, a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero(), a_run_that_could_not_start_is_never_a_verdict_about_the_crate() (+36 more)
...
### Community 76 - "MagiError"
Cohesion: 0.18
Nodes (13): From, MagiError, AgentName, Lineage, Mode, Option, Self, Vec (+5 more)
...
Cohesion: 0.22
Nodes (15): Condition, ConsensusResult, ExtractionFailure, MagiReport, ReportConfig, ReportError, ReportFormatter, AgentName (+7 more)
...
Cohesion: 0.06
Nodes (40): Announcement, AtomicUsize, PreflightError, a_backend_that_does_not_hold_the_probe_model_is_INCONCLUSIVE_not_clear(), a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_cold_model_passes_on_the_second_probe_attempt(), an_endpoint_slow_every_time_still_reports_cannot_test(), no_backend_skips_the_backend_steps_and_nothing_else() (+32 more)
...
Cohesion: 0.09
Nodes (42): a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_listing_larger_than_the_cap_is_not_held_in_memory(), a_probe_that_is_slow_names_both_possible_causes(), a_rotation_candidate_the_backend_does_not_hold_is_refused_too(), a_seat_model_the_backend_does_not_hold_is_refused_before_any_scenario_runs(), Announcement, audit_published_package(), check_lock_is_tracked() (+34 more)
...
Cohesion: 0.09
Nodes (33): a_refused_redirect_is_mage_local_and_never_retried(), completion_new_takes_only_the_mandatory_field(), test_base_zero_with_three_retries_emits_exactly_four_requests(), test_budget_exhaustion_abandons_with_typed_reason(), test_completion_config_default_values(), test_completion_config_is_non_exhaustive(), test_dangerous_config_is_announced_for_retry_after_cap_over_budget(), test_dangerous_config_is_announced_for_zero_base_delay() (+25 more)
...
### Community 199 - "resolve_claude_alias"
Cohesion: 0.29
Nodes (7): Mode, default_model_for_mode(), resolve_claude_alias(), test_default_model_for_mode_composes_with_resolve_claude_alias(), test_resolve_claude_alias_haiku_returns_claude_haiku_4_5_20251001(), test_resolve_claude_alias_opus_returns_claude_opus_4_7(), test_resolve_claude_alias_sonnet_returns_claude_sonnet_4_6()
...
Cohesion: 0.11
Nodes (14): AsRef, Deref, Drop, Into, Self, EnvVarGuard, the_preflight_stops_if_smoke_cargo_lock_is_not_actually_tracked(), an_assertion_that_could_not_be_tested_carries_its_reason() (+6 more)
...
Cohesion: 0.16
Nodes (9): X, ProviderError, Result, X, body_cap(), ProviderResponse, push_within_cap(), Option (+1 more)

### Community 274 - "MagiConfig"
Cohesion: 0.40
...
Cohesion: 0.24
Nodes (6): X, X, RequestBuilder, ProviderRequest, Self, String
...
Cohesion: 0.15
Nodes (11): BTreeSet, Path, an_entry_that_cannot_be_read_is_reported_not_silently_dropped(), FixtureAudit, FixtureEntry, FixtureSummary, Manifest, manifest_load_of_a_missing_file_is_an_empty_manifest_not_an_error() (+3 more)
...
### Community 330 - "external_provider.rs"
Cohesion: 0.20
...
- **Why does `ProviderError` connect `ProviderError` to `provider_url.rs`, `Completion`, `external_provider.rs`, `rotation.rs`, `MagiError`, `.new_checked`, `error.rs`, `ProviderResponse`, `CompletionRecord`, `.redacted`, `.parse`, `HostedModel`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Config` connect `config.rs` to `runner.rs`, `.default`, `RetryConfig`, `preflight.rs`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Completion` connect `Completion` to `Self`, `ollama_wire.rs`, `claude.rs`, `claude_cli.rs`, `MagiError`, `provider.rs`, `openai_compat.rs`, `ollama.rs`?**
