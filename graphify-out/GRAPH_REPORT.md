...
## Corpus Check
- 181 files · ~329,150 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3486 nodes · 7742 edges · 400 communities (200 shown, 200 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `024b30f7`
...
## Communities (400 total, 200 thin omitted)
...
Cohesion: 0.05
Nodes (59): AtomicBool, AtomicUsize, B, Bytes, X, Error, HeaderMap, Incoming (+51 more)
...
### Community 36 - "Announcement"
Cohesion: 0.25
Nodes (9): FixtureSummary, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), Announcement, CostLedger, no_backend_skips_the_backend_steps_and_nothing_else(), Debug, Result, run_against_an_unreachable_backend() (+1 more)
...
Cohesion: 0.06
Nodes (19): Display, Formatter, Into, a_contract_detail_is_capped_at_the_declared_length(), a_contract_detail_under_the_cap_is_untouched(), a_message_of_exactly_the_cap_is_kept_whole(), a_multi_byte_contract_detail_is_cut_without_panicking(), a_short_external_message_survives_untouched() (+11 more)
...
### Community 165 - ".format_model_rotations"
Cohesion: 0.50
...
Cohesion: 0.19
Nodes (12): Assertion, RunId, AssertionRow, CertificateFacts, iso_date_utc(), large_payload_priority(), Option, String (+4 more)
...
- **Why does `ProviderError` connect `ProviderError` to `validate.rs`, `.new`, `LlmProvider`, `rotation.rs`, `HostedModel`, `Result`, `CompletionConfig`, `error.rs`, `provider_url.rs`, `orchestrator.rs`, `ProviderResponse`, `ollama.rs`, `Arc`, `.request`, `.parse`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `String`, `consensus.rs`, `prompts/mod.rs`, `.new`, `LlmProvider`, `test_support.rs`, `ProviderError`, `error.rs`, `orchestrator.rs`, `Arc`, `proxy.rs`?**
