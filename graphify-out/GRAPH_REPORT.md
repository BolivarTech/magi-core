...
## Corpus Check
- 189 files · ~371,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3476 nodes · 8139 edges · 304 communities (205 shown, 99 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2800462d`
...
1. `AgentName` - 85 edges
2. `blank_ctx()` - 60 edges
3. `RunContext` - 53 edges
4. `LlmProvider` - 51 edges
5. `MagiError` - 46 edges
6. `MagiBuilder` - 43 edges
7. `Assertion` - 41 edges
8. `Magi` - 39 edges
9. `Completion` - 38 edges
10. `MagiReport` - 37 edges
...
## Communities (304 total, 99 thin omitted)
...
Cohesion: 0.21
Nodes (20): a_subdirectory_that_cannot_be_read_is_an_error_not_a_silent_skip(), a_target_landing_inside_a_multibyte_character_still_returns_exactly_target_bytes(), collect_from_entries(), collect_rs(), collect_subdir(), falls_short_of_target_fails_loudly_instead_of_returning_a_small_payload(), generate(), ordering_is_bytewise_on_slash_normalized_paths_not_filesystem_order() (+12 more)
...
Cohesion: 0.06
Nodes (44): AgentName, From, Lineage, MagiError, clean_title(), finding_with_title(), output_with_confidence(), output_with_findings() (+36 more)
...
Cohesion: 0.07
Nodes (38): describe(), main(), MinimalProvider, MyBackend, String, Send, Agent, AgentFactory (+30 more)
...
Cohesion: 0.19
Nodes (11): AsRef, Deref, the_preflight_stops_if_smoke_cargo_lock_is_not_actually_tracked(), fresh_temp_dir(), repo_where_the_negation_was_removed(), Drop, Path, PathBuf (+3 more)
...
### Community 17 - ".new"
Cohesion: 0.14
Nodes (29): Elapsed, a_crate_defect_records_nothing_because_its_report_will_not_exist(), a_timed_out_attempt_is_recorded_with_nothing_measured(), echoed_example_response(), mock_agent_json(), mock_agent_object(), parse_agent_response(), parse_and_validate() (+21 more)

### Community 18 - "tempdir_with"
Cohesion: 0.19
Nodes (19): a_file_on_disk_that_nobody_declares_is_an_orphan_too(), a_fixture_whose_hash_changed_is_rejected(), a_manifest_path_that_escapes_the_corpus_is_refused(), a_missing_fixtures_directory_is_reported_not_silently_clean(), a_nested_corpus_is_refused_because_the_walk_does_not_recurse(), a_readable_entry_is_still_crossed_against_the_manifest(), a_verified_by_naming_a_live_scenario_is_accepted(), a_verified_by_naming_no_live_scenario_is_rejected() (+11 more)
...
### Community 21 - "String"
Cohesion: 0.09
Nodes (25): BudgetBearing, Debug, Formatter, Into, Option, ProviderProbe, Result, empty_completion_remedy() (+17 more)

### Community 22 - "Completion"
Cohesion: 0.08
Nodes (17): ProviderError, Result, Self, ProviderError, Result, DeclaringProbe, MockProvider, AtomicUsize (+9 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.08
Nodes (32): ComplexityGate, CapturingMockProvider, contract_prompt(), MagiBuilder, Arc, Box, HashMap, Mutex (+24 more)
...
Cohesion: 0.07
Nodes (27): a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_empty_pool_eligibility_is_still_written_to_the_wire(), an_exceeded_run_gains_exactly_one_section_naming_both_numbers(), an_older_report_without_the_field_still_deserializes() (+19 more)
...
Cohesion: 0.05
Nodes (71): f(), f(), f(), f(), Range, a_budget_inside_the_window_says_nothing(), a_budget_under_the_floor_is_still_reported(), a_limited_class_gets_two_attempts_not_four() (+63 more)
...
### Community 43 - "e2.rs"
Cohesion: 0.08
Nodes (49): assert_that(), content_failure_detail(), e2_scenarios(), erosion_ctx(), r17_fails_rather_than_passing_vacuously_when_nothing_was_measured(), r17_fails_when_only_some_completions_saw_the_large_payload(), r17_fails_when_the_payload_silently_shrank(), r17_passes_when_the_payload_arrived_large() (+41 more)

### Community 44 - "String"
Cohesion: 0.29
Nodes (12): Candidate, EligibilityInputs, empty(), empty_s(), empty_wr(), ModelCapability, RotationPolicy, BTreeMap (+4 more)
...
Cohesion: 0.06
Nodes (16): CompletionTelemetry, Display, FinishReason, AlwaysFailsExternally, a_contract_detail_is_capped_at_the_declared_length(), a_contract_detail_under_the_cap_is_untouched(), a_message_of_exactly_the_cap_is_kept_whole(), a_multi_byte_contract_detail_is_cut_without_panicking() (+8 more)
...
Cohesion: 0.15
Nodes (26): Assertion, BackendNeed, RunContext, Scenario, Source, analyze_produced_a_report(), s15_four_assertions(), s16_no_trace_left_in_the_repo() (+18 more)
...
Cohesion: 0.22
Nodes (12): a_sync_that_cannot_finish_leaves_the_tracked_manifest_alone(), an_entry_that_cannot_be_read_is_reported_not_silently_dropped(), BTreeSet, I, Output, Path, PathBuf, run_sync_from() (+4 more)

### Community 68 - "runner.rs"
Cohesion: 0.10
Nodes (22): SessionFacts, a_timed_out_run_reports_its_cap_verbatim(), build_magi_against(), build_with_absurd_timings(), cannot_test_is_a_skip_with_a_reason_not_a_silent_empty_result(), chat_request(), ProviderKind, Duration (+14 more)

### Community 69 - "SlowFailingProvider"
Cohesion: 0.20
Nodes (4): AtomicUsize, Duration, AbandonReason, SlowFailingProvider
...
Cohesion: 0.09
Nodes (18): AgentSlotGuard, CrateDefectRecord, LineageRegistry, reg(), RegistryInner, Drop, Mutex, test_5xx_does_not_count_toward_endpoint_down() (+10 more)
...
### Community 80 - ".new"
Cohesion: 0.18
Nodes (21): Future, a_receipt_BEFORE_the_runs_is_refused_even_though_the_estimate_was_announced(), a_receipt_is_refused_when_the_intervals_do_not_MATCH_the_announced_runs(), a_run_that_ends_badly_is_still_measured_so_the_receipt_is_not_withheld(), an_absurd_run_payload_does_not_overflow_the_announced_estimate(), announce_cost(), backend_runs_of(), CostLedger (+13 more)
...
### Community 104 - ".write_certificate_in"
Cohesion: 0.22
Nodes (11): CertificateFacts, iso_date_utc(), large_payload_priority(), Option, Path, Result, String, run_label() (+3 more)

### Community 107 - "outcome.rs"
Cohesion: 0.06
Nodes (23): a_hookless_unwind_cannot_inherit_an_earlier_panics_attribution(), a_panic_inside_a_run_is_caught_and_attributed_instead_of_killing_the_harness(), a_run_that_finishes_is_returned_untouched(), classify_panic(), crate_under_test_packages(), every_harness_only_dep_is_ABSENT_from_the_crate_under_tests_own_graph(), exit_code(), graph_query_target_dir() (+15 more)
...
Cohesion: 0.20
Nodes (10): Barrier, digest_collision(), FailingProbe, MockProbe, OverlapProbe, AtomicUsize, Option, ProviderError (+2 more)
...
Cohesion: 0.08
Nodes (29): a_backend_that_does_not_hold_the_probe_model_is_INCONCLUSIVE_not_clear(), a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_cold_model_passes_on_the_second_probe_attempt(), an_endpoint_slow_every_time_still_reports_cannot_test(), AlwaysSlowStub, block_comment_depth_after(), BulkStub, EchoServer (+21 more)
...
### Community 168 - "Vec"
Cohesion: 0.24
Nodes (12): e1_contains_exactly_the_scenarios_valid_against_3_2_0(), e1_scenarios(), render_combinations(), Into, Option, String, Vec, s15_inconclusive() (+4 more)

### Community 173 - "F"
Cohesion: 0.67
Nodes (3): Architecture, Module Dependency Graph, Prompt Injection Defense

### Community 176 - "Announcement"
Cohesion: 0.20
...
Cohesion: 0.19
Nodes (14): ExtractionFailure, InputSize, MagiReport, ReportFormatter, BTreeMap, BTreeSet, Option, String (+6 more)
...
Cohesion: 0.06
Nodes (52): FnOnce, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused(), a_file_that_omits_seats_and_fallbacks_gets_the_built_in_ones(), a_file_value_an_override_rescues_is_judged_on_the_final_set_not_the_file_alone(), a_set_of_overrides_that_is_still_illegal_at_the_end_is_refused(), a_zero_budget_names_the_budget_and_not_the_probe_timeout() (+44 more)

### Community 197 - "redaction_negative.rs"
Cohesion: 0.37
...
Cohesion: 0.23
Nodes (13): classify_error(), ErosionProbe, ErrorClass, injected_agent(), render_error(), Option, String, Vec (+5 more)
...
### Community 210 - "is_privilege_refusal"
Cohesion: 0.50
Nodes (4): is_privilege_refusal(), make_dir_link(), make_symlink(), Error
...
Cohesion: 0.06
Nodes (49): Client, Completion, CompletionConfig, Instant, LlmProvider, ProviderUrl, ReasoningControl, ReasoningState (+41 more)
...
### Community 233 - "CompletionRecord"
Cohesion: 0.13
Nodes (17): CompletionRecord, from_telemetry_copies_every_measurement_across(), from_telemetry_invents_nothing_when_nothing_was_measured(), ReportConfig, ReportError, Default, Display, Formatter (+9 more)

### Community 238 - "Verdict"
Cohesion: 0.18
Nodes (7): Ord, PartialOrd, Display, Formatter, Result, Severity, Verdict
...
### Community 249 - "run"
Cohesion: 0.16
Nodes (16): a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_listing_larger_than_the_cap_is_not_held_in_memory(), PreflightError, raise_proxy(), Display, Error, Into, Self (+8 more)

### Community 251 - "FallbackPool"
Cohesion: 0.14
Nodes (14): FallbackCandidate, FallbackPool, FallbackPoolBuilder, MockProvider, P, Self, test_duplicate_lineage_warns_but_builds(), test_empty_pool_is_valid_and_keeps_max_rotations() (+6 more)
...
Cohesion: 0.11
Nodes (26): a_caller_holding_real_seat_state_produces_the_three_mid_run_causes(), a_seat_with_no_candidates_gets_an_empty_entry_not_a_missing_one(), a_spent_rotation_budget_is_reported_rather_than_read_as_eligible(), ActiveEntry, an_unmeasured_candidate_under_a_strict_guard_says_so(), cand(), CandidateEligibility, extract_item() (+18 more)

### Community 282 - "ProviderError"
Cohesion: 0.07
Nodes (25): D, Deserialize, Error, Mode, Ok, ProviderError, S, Serialize (+17 more)

### Community 283 - "e1.rs"
Cohesion: 0.07
Nodes (68): a_typed_crate_failure_is_a_verdict_about_the_crate(), an_unclassified_failure_is_read_as_the_crate_s(), answered_probes(), blank_ctx(), preflight_error_for_stage(), report_with_caspar_rotation_chain(), Result, s14_does_not_blame_the_crate_for_a_config_fault_of_another_shape() (+60 more)

### Community 289 - "digest_case"
Cohesion: 0.13
Nodes (28): ae(), AgentRotationState, cap(), caps_map(), digest_case(), digest_case_self(), digest_case_two_active(), policy() (+20 more)
...
Cohesion: 0.13
Nodes (33): AbortHandle, DispatchOutcome, JoinError, ExternalErrorKind, a_mage_local_rotation_detail_says_what_happened_and_not_its_scope(), AbortGuard, agent_timeout_message(), attempt_model() (+25 more)
...
Cohesion: 0.12
Nodes (11): Arc, AtomicU32, Default, Mutex, RetryClass, attempts_for(), MockProvider, RetryAfterProvider (+3 more)
