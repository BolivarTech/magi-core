...
## Corpus Check
- 161 files · ~224,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2864 nodes · 6487 edges · 306 communities (185 shown, 121 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0d64c74`
...
## Communities (306 total, 121 thin omitted)
...
### Community 4 - ".analyze"
Cohesion: 0.13
Nodes (33): a_measured_candidate_keeps_the_strict_guard_quiet(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet(), F, staying_under_the_threshold_announces_nothing(), test_a_clean_run_adds_no_section_to_the_human_report() (+25 more)
...
Cohesion: 0.08
Nodes (65): a_probe_declaring_another_model_is_named_not_rejected(), a_probe_declaring_its_own_model_is_quiet(), a_probe_that_claims_nothing_is_checked_against_nothing(), a_threshold_is_unreachable_when_the_smallest_warning_input_is_already_rejected(), a_threshold_that_can_never_fire_is_detected(), a_zero_threshold_warns_always_and_does_not_disable(), an_empty_input_never_exceeds_even_a_zero_threshold(), dispatch_one_agent() (+57 more)

### Community 19 - "CompletionConfig"
Cohesion: 0.10
Nodes (19): JoinError, an_oversized_response_routes_to_its_own_mage_local_outcome(), DeclaringProbe, every_external_shape_routes_to_its_own_mage_local_outcome(), is_connection(), MockProvider, provider_err_outcome(), resolve_abnormal_exit() (+11 more)
...
### Community 25 - "Magi"
Cohesion: 0.17
Nodes (22): AbortHandle, DispatchOutcome, ExternalErrorKind, AbortGuard, attempt_model(), CapturingMockProvider, collect_probe_targets(), default_rotations() (+14 more)
...
Cohesion: 0.14
Nodes (25): a_root_that_exists_but_cannot_be_read_is_reported_while_an_absent_one_is_not(), a_subdirectory_that_cannot_be_read_is_an_error_not_a_silent_skip(), a_target_landing_inside_a_multibyte_character_still_returns_exactly_target_bytes(), an_entry_the_walk_cannot_read_is_an_error_not_a_dropped_file(), block_comment_depth_after(), collect_from_entries(), collect_rs(), collect_subdir() (+17 more)
...
Cohesion: 0.08
Nodes (42): AgentName, Error, Fallback, Injection, Magi, MagiError, Payload, PayloadError (+34 more)
...
Cohesion: 0.07
Nodes (41): AtomicBool, B, Box, Bytes, X, Client, HeaderMap, Incoming (+33 more)

### Community 180 - "AgentOutput"
Cohesion: 0.39
...
### Community 194 - "preflight.rs"
Cohesion: 0.12
Nodes (29): Future, Output, a_cold_model_passes_on_the_second_probe_attempt(), a_config_that_is_not_a_full_trio_is_rejected_as_a_config_fault(), a_config_with_no_fallbacks_is_a_config_fault_not_a_crate_verdict(), a_config_without_seats_is_rejected_by_name_in_the_config_step(), a_fallback_sharing_a_seats_lineage_is_rejected(), a_probe_that_is_slow_names_both_possible_causes() (+21 more)
...
Cohesion: 0.11
Nodes (32): AssertionRow, BuildOutcome, CycleRun, I, RunId, RunResult, a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero() (+24 more)
...
Cohesion: 0.09
Nodes (29): Arc, AtomicUsize, Mutex, PathBuf, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), the_preflight_stops_if_smoke_cargo_lock_is_not_actually_tracked(), AlwaysSlowStub, EchoServer (+21 more)
...
Cohesion: 0.17
Nodes (22): Config, Debug, Display, Duration, Formatter, Into, Path, Result (+14 more)
...
### Community 303 - "Self"
Cohesion: 0.40
Nodes (3): Self, an_assertion_that_could_not_be_tested_carries_its_reason(), Into
...
- **Why does `LlmProvider` connect `LlmProvider` to `RetryAfterProvider`, `.analyze`, `MockProvider`, `MockProbe`, `claude.rs`, `claude_cli.rs`, `test_support.rs`, `CompletionConfig`, `ollama.rs`, `MagiBuilder`, `.new`, `Magi`, `ProviderProbe`, `basic_analysis.rs`, `.complete`, `SlowFailingProvider`, `provider.rs`, `rotation.rs`, `ProviderError`, `HostedModel`, `Instant`, `.new`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `MagiBuilder` connect `MagiBuilder` to `contract_prompt`, `consensus.rs`, `.analyze`, `testkit.rs`, `LlmProvider`, `ReportConfig`, `AgentName`, `MagiConfig`, `Lineage`, `ValidationLimits`, `orchestrator.rs`, `CompletionConfig`, `Magi`, `ProviderProbe`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `run_catching()` connect `outcome.rs` to `runner.rs`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
