...
## Corpus Check
- 181 files · ~328,701 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3484 nodes · 7738 edges · 418 communities (208 shown, 210 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `614f7ca9`
...
## Communities (418 total, 210 thin omitted)
...
Cohesion: 0.06
Nodes (44): Mode, MagiError, From, Option, clean_title(), finding_with_title(), output_with_confidence(), output_with_findings() (+36 more)
...
Cohesion: 0.09
Nodes (33): Agent, AgentFactory, MockProvider, AgentName, Arc, AtomicUsize, BTreeMap, Default (+25 more)
...
Cohesion: 0.07
Nodes (48): Debug, FinishReason, Instant, LlmProvider, ProviderUrl, ReasoningState, a_non_text_block_with_a_normal_ending_is_not_reported_as_a_budget_cut(), a_non_text_contract_failure_names_the_shape_it_saw() (+40 more)
...
Cohesion: 0.05
Nodes (57): AtomicBool, B, Bytes, X, Error, HeaderMap, Incoming, Infallible (+49 more)

### Community 25 - "reporting.rs"
Cohesion: 0.07
Nodes (29): DedupFinding, Dissent, a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_exceeded_run_gains_exactly_one_section_naming_both_numbers() (+21 more)
...
### Community 36 - "test_support.rs"
Cohesion: 0.13
Nodes (21): Lineage, Magi, Beh, build_oversized_case(), build_schema_local_case(), build_trio_with_caspar(), build_two_5xx_with_local_fallbacks(), build_two_external_failing_no_fallback() (+13 more)
...
Cohesion: 0.20
Nodes (9): ReportError, Formatter, Result, test_new_checked_accepts_all_ascii_titles(), test_new_checked_rejects_banner_width_too_small(), test_new_checked_rejects_non_ascii_display_name(), test_new_checked_rejects_non_ascii_title_field(), test_with_config_rejects_banner_width_too_small() (+1 more)
...
Cohesion: 0.07
Nodes (51): AssertionRow, BuildOutcome, CostLedger, CycleRun, ErosionProbe, I, Output, PreflightError (+43 more)
...
Cohesion: 0.18
Nodes (11): From, Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), Completion, CompletionTelemetry, finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary(), FinishReason (+3 more)
...
### Community 121 - "rotation_integration.rs"
Cohesion: 0.11
...
Cohesion: 0.18
Nodes (17): AgentName, AgentOutput, AgentRotation, Condition, ConsensusResult, ExtractionFailure, InputSize, MagiReport (+9 more)
...
Cohesion: 0.08
Nodes (29): AtomicUsize, a_backend_that_does_not_hold_the_probe_model_is_INCONCLUSIVE_not_clear(), a_cold_model_passes_on_the_second_probe_attempt(), an_endpoint_slow_every_time_still_reports_cannot_test(), AlwaysSlowStub, block_comment_depth_after(), BulkStub, EchoServer (+21 more)
...
### Community 165 - "ProviderError"
Cohesion: 0.18
Nodes (16): CompletionTelemetry, a_message_of_exactly_the_cap_is_kept_whole(), a_short_external_message_survives_untouched(), AbandonReason, an_oversized_external_message_is_cut_and_says_so(), external_message(), ExternalErrorKind, ProviderError (+8 more)
...
Cohesion: 0.09
Nodes (11): describe(), main(), MinimalProvider, MyBackend, Result, String, AlwaysFailsExternally, Result (+3 more)
...
### Community 199 - "PreflightError"
Cohesion: 0.13
Nodes (16): FixtureSummary, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), Announcement, no_backend_skips_the_backend_steps_and_nothing_else(), preflight_step_order(), PreflightError, Debug, Error (+8 more)
...
### Community 202 - ".new"
Cohesion: 0.14
Nodes (19): Completion, CompletionConfig, HashMap, ProviderError, ProviderProbe, MockProbe, RoutingMockProvider, AgentName (+11 more)
...
Cohesion: 0.35
Nodes (7): ReasoningState, Option, CompletionRecord, from_telemetry_copies_every_measurement_across(), from_telemetry_invents_nothing_when_nothing_was_measured(), Self, the_unsupported_declaration_survives_the_conversion()

### Community 211 - "MockProvider"
Cohesion: 0.13
Nodes (10): AtomicU32, RetryClass, MockProvider, RetryAfterProvider, RetryConfig, RetryProvider, Arc, Default (+2 more)
...
### Community 217 - "fixtures.rs"
Cohesion: 0.26
Nodes (10): BTreeSet, Path, a_sync_that_cannot_finish_leaves_the_tracked_manifest_alone(), an_empty_manifest_verifies_clean_which_is_exactly_e1(), an_entry_that_cannot_be_read_is_reported_not_silently_dropped(), run_sync_from(), sync_fixtures_creates_nothing_beside_the_fixture_directory(), sync_fixtures_writes_the_same_place_from_any_directory() (+2 more)
...
Cohesion: 0.06
Nodes (21): a_refused_redirect_is_mage_local_and_never_retried(), completion_new_takes_only_the_mandatory_field(), default_model_for_mode(), no_synthetic_http_status_survives_anywhere_in_the_crate(), resolve_claude_alias(), Mode, test_completion_config_default_values(), test_completion_config_is_non_exhaustive() (+13 more)
...
### Community 237 - "redaction_negative.rs"
Cohesion: 0.37
...
### Community 259 - ".response_contract"
Cohesion: 0.18
Nodes (9): Display, Formatter, Into, a_contract_detail_is_capped_at_the_declared_length(), a_contract_detail_under_the_cap_is_untouched(), a_multi_byte_contract_detail_is_cut_without_panicking(), ResponseContractCause, Result (+1 more)

### Community 267 - "[3.0.2] - 2026-07-30"
Cohesion: 0.67
Nodes (3): [3.0.2] - 2026-07-30, Changed, Fixed

### Community 268 - "HostedModel"
Cohesion: 0.24
Nodes (5): HostedModel, Option, Result, String, SidecarProbe

### Community 269 - "SlowFailingProvider"
Cohesion: 0.25
...
### Community 282 - "embedded_prompt_for"
Cohesion: 0.57
...
Cohesion: 0.15
Nodes (13): Ok, S, cause_chain(), cause_chain_skips_the_top_level_error(), classify(), client_build_error(), every_contract_variant_has_its_own_retry_class(), FailingProvider (+5 more)

### Community 344 - "AssertionRow"
Cohesion: 0.14
Nodes (17): Assertion, RunId, AssertionRow, both_renderers_name_the_cap_that_was_exceeded_rather_than_an_overrun(), CertificateFacts, format_row(), iso_date_utc(), large_payload_priority() (+9 more)

### Community 369 - "run"
Cohesion: 0.27
Nodes (9): a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_listing_larger_than_the_cap_is_not_held_in_memory(), run(), the_backend_step_and_the_probe_step_ask_different_questions(), the_contention_probe_sends_a_real_completion_not_a_manifest_listing(), the_preflight_itself_refuses_a_seat_model_the_backend_does_not_list(), the_window_bound_has_one_entry_per_request_the_preflight_makes(), stub_that_lists_models() (+1 more)

### Community 380 - "preflight.rs"
Cohesion: 0.09
Nodes (35): a_probe_answered_with_404_names_both_possible_causes_too(), a_probe_that_is_slow_names_both_possible_causes(), a_rotation_candidate_the_backend_does_not_hold_is_refused_too(), a_seat_model_the_backend_does_not_hold_is_refused_before_any_scenario_runs(), an_isolated_package_passes_the_workspace_check(), an_unsuccessful_status_is_not_described_as_a_successful_answer(), audit_published_package(), check_lock_is_tracked() (+27 more)
...
- **Why does `ProviderError` connect `ProviderError` to `.default`, `validate.rs`, `.response_contract`, `.analyze`, `LlmProvider`, `HostedModel`, `ProviderResponse`, `orchestrator.rs`, `ollama.rs`, `Arc`, `.request`, `CompletionConfig`, `error.rs`, `provider_url.rs`, `.parse`, `rotation.rs`, `.builder`, `OllamaProvider`, `String`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `String`, `consensus.rs`, `prompts/mod.rs`, `test_support.rs`, `ProviderError`, `LlmProvider`, `.analyze`, `error.rs`, `orchestrator.rs`, `Arc`, `proxy.rs`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `SpyProxy` connect `proxy.rs` to `runner.rs`, `preflight.rs`, `Arc`, `PreflightError`?**
