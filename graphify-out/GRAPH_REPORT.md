...
## Corpus Check
- 103 files · ~126,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2064 nodes · 4554 edges · 234 communities (128 shown, 106 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afc2161e`
...
## Communities (234 total, 106 thin omitted)
...
Cohesion: 0.10
Nodes (17): X, X, X, ProviderError, Result, X, Option, RequestBuilder (+9 more)
...
### Community 17 - ".new"
Cohesion: 0.07
Nodes (51): AgentName, BTreeSet, HashMap, Lineage, Magi, MagiReport, Mutex, Beh (+43 more)
...
Cohesion: 0.12
Nodes (17): OpenAiCompatibleProvider, a_mounted_prefix_survives_both_spellings(), a_root_that_really_ends_in_v1_is_read_as_the_prefix(), every_accepted_spelling_yields_the_same_endpoints(), new_gives_the_inner_provider_the_real_credentials(), OllamaProvider, CompletionConfig, LlmProvider (+9 more)
...
Cohesion: 0.08
Nodes (31): Client, Debug, Display, Method, a_partial_read_stays_within_the_cap_including_its_marker(), canonicalizing_does_not_touch_the_query_or_the_fragment(), debug_and_display_are_both_redacted(), diagnostic_truncation_is_announced_and_utf8_safe() (+23 more)
...
Cohesion: 0.18
Nodes (7): Arc, AtomicU32, Default, RetryClass, MockProvider, RetryConfig, RetryProvider
...
Cohesion: 0.08
Nodes (19): From, Instant, Into, a_short_external_message_survives_untouched(), AbandonReason, an_oversized_external_message_is_cut_and_says_so(), external_message(), ExternalErrorKind (+11 more)
...
Cohesion: 0.11
Nodes (11): AtomicUsize, Duration, Formatter, ProviderError, Result, classify(), CompletionConfig, FailingProvider (+3 more)
...
Cohesion: 0.06
Nodes (31): f(), f(), f(), Error, Mode, cause_chain(), cause_chain_skips_the_top_level_error(), client_build_error() (+23 more)
...
- **Why does `LlmProvider` connect `[0.3.0] - 2026-04-18` to `orchestrator.rs`, `Finding`, `.new`, `7. Design Philosophy`, `error.rs`, `claude.rs`, `MockProvider`, `FallbackPool`, `claude_cli.rs`, `mod.rs`, `RoutingMockProvider`, `Instant`, `.cmp`, `dispatch_one_agent`, `LlmProvider`, `String`, `.complete`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `AgentName` connect `Error` to `5. Data Schema and Consensus Protocol`, `[0.3.0] - 2026-04-18`, `consensus.rs`, `AgentOutput`, `.fmt`, `RequestBuilder`, `error.rs`, `openai_compat.rs`, `schema.rs`, `Lineage`, `1. Origin: The MAGI Supercomputers from Evangelion`, `mod.rs`, `compose_transport_message`, `.send`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `RetryClass` connect `backoff.rs` to `bytes`?**
