...
## Corpus Check
- 42 files · ~103,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1569 nodes · 3975 edges · 103 communities (67 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3f5e8b6`
...
Cohesion: 0.11
Nodes (36): echoed_example_response(), magi_error_for(), mock_agent_json(), mock_agent_object(), parse_agent_response(), parse_and_validate(), parse_validate_and_check(), ParseFailure (+28 more)

### Community 1 - "reporting.rs"
Cohesion: 0.07
Nodes (70): ExtractionFailure, fit_content(), MagiReport, make_agent(), make_consensus(), ReportConfig, ReportError, ReportFormatter (+62 more)
...
### Community 4 - "Finding"
Cohesion: 0.11
Nodes (41): F, Mutex, test_a_clean_run_adds_no_section_to_the_human_report(), test_a_failure_before_rotation_is_attributed_to_the_pre_rotation_model(), test_a_recovered_retry_still_records_its_cause(), test_analyze_all_agents_fail_returns_insufficient_agents(), test_analyze_input_too_large_rejects_without_launching_agents(), test_analyze_no_retry_on_timeout_keeps_retried_empty() (+33 more)

### Community 5 - ".new"
Cohesion: 0.30
Nodes (15): AgentRotationState, Candidate, cap(), caps_map(), digest_case(), digest_case_self(), digest_case_two_active(), digest_collision() (+7 more)
...
Cohesion: 0.08
Nodes (35): CompletionConfig, ClaudeMessage, ClaudeProvider, ClaudeRequest, ClaudeResponse, ContentBlock, Client, Debug (+27 more)
...
Cohesion: 0.09
Nodes (23): AgentSlotGuard, reg(), Arc, Drop, test_5xx_does_not_count_toward_endpoint_down(), test_active_unverifiable_digest_does_not_block_rotation(), test_calling_agent_excluded_from_digest_check(), test_candidate_without_digest_is_accepted_trusting_lineage() (+15 more)

### Community 22 - "finding_id.rs"
Cohesion: 0.14
Nodes (14): Barrier, FailingProbe, MockProbe, OverlapProbe, ProviderProbe, AtomicUsize, Result, Send (+6 more)

### Community 23 - ".cmp"
Cohesion: 0.43
Nodes (6): contract_prompt(), test_analyze_applies_mode_agnostic_override_to_melchior(), test_analyze_per_mode_override_supersedes_all_modes(), test_analyze_respects_prompts_dir_loaded_files(), test_legacy_with_custom_prompt_shim_roundtrip(), test_with_custom_prompt_all_modes_stores_with_none_key()

### Community 24 - "dispatch_one_agent"
Cohesion: 0.25
Nodes (13): dispatch_one_agent(), test_dispatch_one_agent_does_not_retry_on_auth_error(), test_dispatch_one_agent_does_not_retry_on_http_429(), test_dispatch_one_agent_does_not_retry_on_http_500(), test_dispatch_one_agent_does_not_retry_on_nested_session(), test_dispatch_one_agent_does_not_retry_on_network_error(), test_dispatch_one_agent_does_not_retry_on_provider_timeout(), test_dispatch_one_agent_retries_on_deserialization_and_fails() (+5 more)

### Community 25 - "LlmProvider"
Cohesion: 0.14
Nodes (21): AbortHandle, DispatchOutcome, AbortGuard, attempt_model(), CapturingMockProvider, collect_probe_targets(), default_rotations(), dispatch_one_agent_rotating() (+13 more)
...
Cohesion: 0.06
Nodes (48): ComplexityGate, PathBuf, Agent, AgentFactory, MockProvider, Arc, AtomicUsize, BTreeMap (+40 more)
...
Cohesion: 0.08
Nodes (39): Beh, build_schema_local_case(), build_trio_with_caspar(), build_two_5xx_with_local_fallbacks(), build_two_failing_with_single_free_fallback(), build_two_network_failing_no_fallback(), MockProbe, ok() (+31 more)
...
Cohesion: 0.13
Nodes (15): [0.1.2] - 2026-04-05, [1.0.1] - 2026-05-25, [2.1.0] - 2026-07-27, [2.2.0] - 2026-07-27, [3.0.1] - 2026-07-30, Added, Changed, Changed (+7 more)
...
Cohesion: 0.12
Nodes (17): Architecture, Changelog, Consensus Labels, Contribution, Declaring fallbacks, Example, Feature Flags, Features (+9 more)
...
Cohesion: 0.12
Nodes (11): Lineage, MockProvider, RotationEvent, RotationKind, Cow, Display, Formatter, From (+3 more)
...
Cohesion: 0.22
Nodes (5): RetryClass, RetryConfig, RetryProvider, Arc, Default
...
Cohesion: 0.50
Nodes (4): JoinError, resolve_abnormal_exit(), resolve_endpoint_down(), test_abnormal_exit_recovers_endpoint_down_from_registry()

### Community 72 - "[0.3.1] - 2026-04-19"
Cohesion: 0.67
...
Cohesion: 0.12
Nodes (16): AtomicU32, AbandonReason, ProviderError, Duration, Instant, String, classify(), FailingProvider (+8 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `Fixed`, `Changed`, `Notes`, `BREAKING`, `Added` (+159 more)
...
- **Why does `ProviderError` connect `ProviderError` to `[0.3.0] - 2026-04-18`, `validate.rs`, `Finding`, `RoutingMockProvider`, `provider.rs`, `openai_compat.rs`, `claude.rs`, `MockProvider`, `claude_cli.rs`, `String`, `error.rs`, `Lineage`, `prelude.rs`, `finding_id.rs`, `LlmProvider`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `orchestrator.rs`, `[0.3.0] - 2026-04-18`, `consensus.rs`, `2. Translation to the Software Engineering Domain`, `Finding`, `ProviderError`, `5. Data Schema and Consensus Protocol`, `[1.1.1] - 2026-07-17`, `user_prompt.rs`, `error.rs`, `Lineage`, `LlmProvider`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `AgentName` connect `[0.3.0] - 2026-04-18` to `orchestrator.rs`, `5. Data Schema and Consensus Protocol`, `consensus.rs`, `validate.rs`, `2. Translation to the Software Engineering Domain`, `reporting.rs`, `.new`, `schema.rs`, `AgentName`, `RoutingMockProvider`, `Vec`, `prelude.rs`, `.cmp`, `LlmProvider`, `lib.rs`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **What connects `Fixed`, `Changed`, `Notes` to the rest of the system?**
...
- **Should `reporting.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.06510565391205025 - nodes in this community are weakly interconnected._
