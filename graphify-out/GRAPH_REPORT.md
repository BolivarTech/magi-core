...
## Corpus Check
- 186 files · ~348,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3602 nodes · 7984 edges · 465 communities (211 shown, 254 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `625edeff`
...
## Communities (465 total, 254 thin omitted)

### Community 0 - "ProviderError"
Cohesion: 0.05
Nodes (52): Completion, CompletionConfig, HashMap, Magi, ProviderError, FailingProvider, Beh, build_oversized_case() (+44 more)
...
Cohesion: 0.11
Nodes (57): dedup_key(), DedupKey, finding_key(), make_output(), Result, test_agent_count_reflects_input_count(), test_approve_conditional_reject_produces_go_with_caveats(), test_conditions_are_distinct_from_recommendations_section() (+49 more)
...
### Community 4 - ".new"
Cohesion: 0.09
Nodes (61): MagiReport, a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), contract_prompt(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance() (+53 more)

### Community 5 - ".default"
Cohesion: 0.09
Nodes (23): Range, a_budget_inside_the_window_says_nothing(), a_limited_class_gets_two_attempts_not_four(), a_single_honoured_wait_that_eats_the_whole_budget_is_flagged(), a_wait_exactly_equal_to_the_budget_is_flagged_too(), budget_window(), test_completion_config_default_values(), test_completion_config_is_non_exhaustive() (+15 more)

### Community 6 - "LlmProvider"
Cohesion: 0.07
Nodes (37): describe(), main(), MinimalProvider, MyBackend, Result, String, Agent, AgentFactory (+29 more)
...
Cohesion: 0.06
Nodes (68): AgentOutput, CrateDefectRecord, ExtractionFailureCause, InputSize, a_threshold_is_unreachable_when_the_smallest_warning_input_is_already_rejected(), a_threshold_that_can_never_fire_is_detected(), a_zero_threshold_warns_always_and_does_not_disable(), an_empty_input_never_exceeds_even_a_zero_threshold() (+60 more)
...
Cohesion: 0.09
Nodes (25): Config, PayloadError, SessionFacts, a_timed_out_run_reports_its_cap_verbatim(), BackendNeed, build_with_absurd_timings(), chat_request(), probe_is_in_scope() (+17 more)

### Community 18 - ".new_checked"
Cohesion: 0.16
Nodes (12): ReportConfig, ReportError, Default, Formatter, Result, test_banner_verdict_preserved_when_label_exceeds_width(), test_new_checked_accepts_all_ascii_titles(), test_new_checked_rejects_banner_width_too_small() (+4 more)
...
### Community 22 - "Error"
Cohesion: 0.16
Nodes (13): D, Deserialize, Error, Ok, S, Serialize, cause_chain(), cause_chain_skips_the_top_level_error() (+5 more)

### Community 23 - "Self"
Cohesion: 0.09
Nodes (27): AgentFactory, Arc, Box, ComplexityGate, ConsensusConfig, ConsensusEngine, FallbackPool, Lineage (+19 more)
...
Cohesion: 0.08
Nodes (25): DedupFinding, a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_exceeded_run_gains_exactly_one_section_naming_both_numbers(), an_older_report_without_the_field_still_deserializes() (+17 more)
...
Cohesion: 0.07
Nodes (13): a_refused_redirect_is_mage_local_and_never_retried(), completion_new_takes_only_the_mandatory_field(), default_model_for_mode(), no_synthetic_http_status_survives_anywhere_in_the_crate(), production_half(), resolve_claude_alias(), test_default_model_for_mode_composes_with_resolve_claude_alias(), test_resolve_claude_alias_haiku_returns_claude_haiku_4_5_20251001() (+5 more)
...
### Community 44 - "String"
Cohesion: 0.10
Nodes (17): ExternalErrorKind, Formatter, Option, ProviderProbe, a_completion_record_is_built_in_exactly_one_place(), a_mage_local_rotation_detail_says_what_happened_and_not_its_scope(), a_probe_declaring_another_model_is_named_not_rejected(), a_probe_declaring_its_own_model_is_quiet() (+9 more)
...
Cohesion: 0.06
Nodes (24): Display, a_contract_detail_is_capped_at_the_declared_length(), a_contract_detail_under_the_cap_is_untouched(), a_message_of_exactly_the_cap_is_kept_whole(), a_multi_byte_contract_detail_is_cut_without_panicking(), a_short_external_message_survives_untouched(), AbandonReason, an_oversized_external_message_is_cut_and_says_so() (+16 more)
...
Cohesion: 0.10
Nodes (23): balthasar_prompt(), caspar_prompt(), embedded_prompt_for(), lookup_prompt(), melchior_prompt(), BTreeMap, Option, Result (+15 more)
...
Cohesion: 0.15
Nodes (23): Fallback, Injection, Payload, RequestRecord, RunOutcome, Seat, attempts_for(), build_magi_against() (+15 more)

### Community 70 - "main.rs"
Cohesion: 0.09
Nodes (38): AssertionRow, CycleRun, I, Output, PreflightError, a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero(), a_run_that_could_not_start_is_never_a_verdict_about_the_crate() (+30 more)
...
### Community 80 - "Completion"
Cohesion: 0.13
Nodes (14): From, Completion, ClaudeProvider, parse_any(), parse_ok(), Client, Debug, Duration (+6 more)
...
Cohesion: 0.10
Nodes (7): AlwaysFailsExternally, Result, CompletionConfig, ReasoningControl, RetryAfterProvider, SlowFailingProvider, the_provider_trace_and_the_verdict_reasoning_are_different_fields()
...
### Community 144 - ".map_status_to_error"
Cohesion: 0.19
...
Cohesion: 0.23
Nodes (12): de_category(), de_opt_file(), de_opt_line(), generate_finding_id(), normalize_category(), normalize_path(), Error, Option (+4 more)
...
### Community 177 - "RunId"
Cohesion: 0.19
Nodes (12): Assertion, FixtureSummary, RunId, CertificateFacts, iso_date_utc(), large_payload_priority(), Option, String (+4 more)
...
Cohesion: 0.21
Nodes (13): AgentRotation, Condition, ConsensusResult, ExtractionFailure, InputSize, MagiReport, ReportFormatter, Option (+5 more)

### Community 193 - "RunContext"
Cohesion: 0.32
Nodes (14): ScenarioState, Assertion, RunContext, Scenario, f_scenarios(), no_timings_skips_instead_of_passing(), Vec, s_f1() (+6 more)
...
Cohesion: 0.15
Nodes (8): AtomicU32, Default, RetryClass, attempts_for(), is_retryable(), MockProvider, RetryConfig, RetryProvider

### Community 212 - "common/mod.rs"
Cohesion: 0.19
Nodes (14): TcpListener, TcpStream, accept_one(), bind_loopback(), captured_warnings(), ends_header(), hang_up(), F (+6 more)

### Community 214 - "body_bounds.rs"
Cohesion: 0.26
...
### Community 233 - ".skip"
Cohesion: 0.29
Nodes (4): Into, an_assertion_that_could_not_be_tested_carries_its_reason(), Self, RunContext<'static>
...
### Community 269 - "dispatch_measured"
Cohesion: 0.25
Nodes (9): CostLedger, dispatch_measured(), dispatching_alone_cannot_produce_a_receipt_the_estimate_never_preceded(), ExecutesRuns, RecordingRunner, Vec, runner::Runner, stage_specs() (+1 more)
...
Cohesion: 0.11
Nodes (36): AbortHandle, Agent, AgentName, BTreeMap, CompletionRecord, DispatchOutcome, Elapsed, ExtractionFailure (+28 more)

### Community 354 - "Duration"
Cohesion: 0.22
Nodes (6): Duration, agent_timeout_message(), build_with(), build_with_honours_the_three_values_it_takes(), it_never_returns_err_no_matter_how_absurd_the_configuration(), the_worst_case_is_per_seat_and_never_multiplies_by_the_trio()
...
Cohesion: 0.33
Nodes (6): AssertionRow, both_renderers_name_the_cap_that_was_exceeded_rather_than_an_overrun(), format_row(), row_to_json(), state_marker(), Value
...
### Community 432 - "run_where_the_first_response_fails_schema_and_the_retry_succeeds"
Cohesion: 0.60
...
### Community 437 - "CompletionTelemetry"
Cohesion: 0.18
Nodes (6): an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), BudgetBearing, classify(), CompletionTelemetry, every_contract_variant_has_its_own_retry_class(), the_control_is_set_through_a_builder_because_the_struct_is_non_exhaustive()
...
## Knowledge Gaps
- **240 isolated node(s):** `RunContext<'static>`, `melchior`, `report`, `X`, `8. Evangelion Correspondence Table` (+235 more)
...
- **Why does `ProviderError` connect `ProviderError` to `OllamaProvider`, `validate.rs`, `LlmProvider`, `.redacted`, `CompletionConfig`, `rotation.rs`, `String`, `provider_url.rs`, `Completion`, `HostedModel`, `.map_status_to_error`, `ProviderResponse`, `openai_compat.rs`, `CompletionTelemetry`, `Error`, `ollama.rs`, `claude.rs`, `.parse`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `prompts/mod.rs`, `consensus.rs`, `LlmProvider`, `ProviderError`, `AgentName`, `Self`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `EventLog` connect `EventLog` to `orchestrator.rs`, `AgentName`, `String`, `Self`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `RunContext<'static>`, `melchior`, `report` to the rest of the system?**
  _240 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `ProviderError` be split into smaller, more focused modules?**
...
- **Should `consensus.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.11367127496159754 - nodes in this community are weakly interconnected._
