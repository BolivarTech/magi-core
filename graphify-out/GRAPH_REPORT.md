...
## Corpus Check
- 181 files · ~335,202 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3507 nodes · 7773 edges · 415 communities (197 shown, 218 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d91f8482`
...
### Community 4 - ".new"
Cohesion: 0.09
Nodes (62): MagiReport, a_completion_record_is_built_in_exactly_one_place(), a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), contract_prompt(), exceeding_the_threshold_warns_and_still_completes() (+54 more)
...
### Community 9 - "ProviderError"
Cohesion: 0.18
Nodes (9): Ok, ProviderError, Result, RetryClass, S, classify(), every_contract_variant_has_its_own_retry_class(), FailingProvider (+1 more)
...
Cohesion: 0.09
Nodes (49): Agent, AgentOutput, Arc, BTreeMap, CompletionRecord, CrateDefectRecord, DispatchOutcome, Elapsed (+41 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.10
Nodes (24): AgentFactory, Box, ComplexityGate, ConsensusConfig, ConsensusEngine, FallbackPool, P, ReportConfig (+16 more)
...
Cohesion: 0.08
Nodes (23): Dissent, a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_exceeded_run_gains_exactly_one_section_naming_both_numbers(), an_older_report_without_the_field_still_deserializes() (+15 more)
...
### Community 42 - "Cow"
Cohesion: 0.18
Nodes (12): Cow, Into, trim_cow(), neutralize_headers(), normalize_newlines(), sanitize_error_for_retry_feedback(), strip_invisibles(), test_neutralize_headers_not_bypassed_by_mongolian_vowel_separator() (+4 more)
...
Cohesion: 0.22
Nodes (5): Lineage, RotationEvent, RotationKind, Display, From
...
Cohesion: 0.10
Nodes (12): extract_item(), Mutex, test_active_unverifiable_digest_does_not_block_rotation(), test_calling_agent_excluded_from_digest_check(), test_candidate_without_digest_is_accepted_trusting_lineage(), test_endpoint_down_latch_exactly_one_true_concurrent(), test_lineage_from_owned_string_is_owned(), test_lineage_from_static_is_borrowed_zero_alloc() (+4 more)
...
### Community 104 - "Self"
Cohesion: 0.16
Nodes (11): From, Self, Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), BudgetBearing, Completion, CompletionTelemetry, finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it() (+3 more)

### Community 107 - "outcome.rs"
Cohesion: 0.07
Nodes (20): BTreeSet, a_hookless_unwind_cannot_inherit_an_earlier_panics_attribution(), a_panic_inside_a_run_is_caught_and_attributed_instead_of_killing_the_harness(), a_run_that_finishes_is_returned_untouched(), classify_panic(), crate_under_test_packages(), every_harness_only_dep_is_ABSENT_from_the_crate_under_tests_own_graph(), exit_code() (+12 more)
...
### Community 121 - "compose_transport_message"
Cohesion: 0.12
...
Cohesion: 0.17
Nodes (17): AgentName, AgentRotation, Condition, ConsensusResult, ExtractionFailure, InputSize, MagiReport, ReportFormatter (+9 more)

### Community 132 - "LineageRegistry"
Cohesion: 0.13
Nodes (17): ActiveEntry, AgentSlotGuard, CrateDefectRecord, LineageRegistry, reg(), RegistryInner, RotationConfig, AgentName (+9 more)
...
Cohesion: 0.09
Nodes (25): AtomicUsize, a_cold_model_passes_on_the_second_probe_attempt(), AlwaysSlowStub, block_comment_depth_after(), BulkStub, EchoServer, is_privilege_refusal(), ListingStub (+17 more)
...
### Community 180 - "validate_prompt_for"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (10): AsRef, Deref, Drop, EnvVarGuard, fresh_temp_dir(), repo_where_the_negation_was_removed(), Path, Self (+2 more)

### Community 196 - "config.rs"
Cohesion: 0.06
Nodes (52): Default, Deserialize, Duration, FnOnce, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused(), a_file_that_omits_seats_and_fallbacks_gets_the_built_in_ones() (+44 more)

### Community 199 - "String"
Cohesion: 0.23
Nodes (14): audit_published_package(), check_lock_is_tracked(), check_workspace_isolation(), harness_files_in_listing(), listed_models(), nothing_under_the_harness_reaches_the_published_crate(), PackageAudit, reachable() (+6 more)

### Community 200 - ".format_findings"
Cohesion: 0.29
...
Cohesion: 0.13
Nodes (11): AtomicU32, MockProvider, RetryAfterProvider, RetryConfig, RetryProvider, test_dangerous_config_is_announced_for_retry_after_cap_over_budget(), test_dangerous_config_is_announced_for_zero_base_delay(), test_dangerous_config_is_announced_for_zero_cap() (+3 more)

### Community 212 - "dedup_key"
Cohesion: 0.33
...
### Community 235 - "ProviderProbe"
Cohesion: 0.11
Nodes (12): Barrier, FailingProbe, MockProbe, MockProvider, OverlapProbe, ProviderProbe, AtomicUsize, Completion (+4 more)

### Community 236 - ".send"
Cohesion: 0.50
Nodes (3): ProviderError, Result, X

### Community 237 - "empty_completion_remedy"
Cohesion: 0.67
Nodes (3): BudgetBearing, empty_completion_remedy(), Option

### Community 238 - "ProviderError"
Cohesion: 0.14
Nodes (12): HostedModel, Option, Result, String, SidecarProbe, AbandonReason, ProviderError, CompletionTelemetry (+4 more)
...
Cohesion: 0.13
Nodes (12): ExitCode, a_harness_fault_reports_the_cycle_run_it_actually_was(), a_row_that_belongs_to_no_run_is_not_attributed_to_one(), a_time_failure_renders_visibly_different_from_an_assertion_failure(), a_verdict_about_the_crate_outranks_our_own_failure_to_certify(), both_renderers_carry_the_scenario_id_its_field_promises(), cycle_run_label(), CycleRun (+4 more)
...
### Community 251 - "Self"
Cohesion: 0.16
Nodes (14): FallbackCandidate, FallbackPool, FallbackPoolBuilder, LlmProvider, P, Self, test_duplicate_lineage_warns_but_builds(), test_empty_pool_is_valid_and_keeps_max_rotations() (+6 more)

### Community 258 - "run"
Cohesion: 0.13
Nodes (20): a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_listing_larger_than_the_cap_is_not_held_in_memory(), Announcement, no_backend_skips_the_backend_steps_and_nothing_else(), PreflightError, raise_proxy(), Debug (+12 more)
...
### Community 278 - "CompletionConfig"
Cohesion: 0.11
Nodes (6): AlwaysFailsExternally, Result, CompletionConfig, ReasoningControl, SlowFailingProvider, the_provider_trace_and_the_verdict_reasoning_are_different_fields()
...
Cohesion: 0.16
Nodes (30): ae(), AgentRotation, AgentRotationState, Candidate, cap(), caps_map(), digest_case(), digest_case_self() (+22 more)
...
Cohesion: 0.06
Nodes (22): Error, Mode, a_refused_redirect_is_mage_local_and_never_retried(), cause_chain(), cause_chain_skips_the_top_level_error(), client_build_error(), completion_new_takes_only_the_mandatory_field(), default_model_for_mode() (+14 more)

### Community 327 - ".redacted"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (16): Assertion, FixtureSummary, RunId, AssertionRow, both_renderers_name_the_cap_that_was_exceeded_rather_than_an_overrun(), CertificateFacts, format_row(), iso_date_utc() (+8 more)

### Community 369 - ".default"
Cohesion: 0.14
Nodes (21): a_backend_holding_every_seat_model_passes_the_check(), a_backend_that_does_not_hold_the_probe_model_is_INCONCLUSIVE_not_clear(), a_config_that_is_not_a_full_trio_is_rejected_as_a_config_fault(), a_config_with_no_fallbacks_is_a_config_fault_not_a_crate_verdict(), a_config_without_seats_is_rejected_by_name_in_the_config_step(), a_fallback_sharing_a_seats_lineage_is_rejected(), a_fallback_sharing_a_seats_model_is_rejected(), an_endpoint_slow_every_time_still_reports_cannot_test() (+13 more)

### Community 380 - "preflight.rs"
Cohesion: 0.09
Nodes (28): a_probe_answered_with_404_names_both_possible_causes_too(), a_probe_that_is_slow_names_both_possible_causes(), a_rotation_candidate_the_backend_does_not_hold_is_refused_too(), a_seat_model_the_backend_does_not_hold_is_refused_before_any_scenario_runs(), an_absurd_run_payload_does_not_overflow_the_announced_estimate(), an_unsuccessful_status_is_not_described_as_a_successful_answer(), announce_cost(), check_seat_models() (+20 more)
...
### Community 397 - "Option"
Cohesion: 0.25
Nodes (4): Option, FixtureSummary, the_end_of_run_count_names_both_classes(), the_thirty_percent_warning_fires_only_strictly_above_the_threshold()
...
- **Why does `ProviderError` connect `ProviderError` to `.new`, `LlmProvider`, `ProviderResponse`, `orchestrator.rs`, `ollama.rs`, `CompletionConfig`, `MagiError`, `String`, `OllamaProvider`, `.complete`, `error.rs`, `.parse`, `.redacted`, `rotation.rs`, `provider_url.rs`, `.external`, `ResponseContractCause`, `claude.rs`, `ProviderProbe`, `empty_completion_remedy`, `openai_compat.rs`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `MagiError` connect `MagiError` to `provider.rs`, `String`, `consensus.rs`, `test_support.rs`, `.new`, `prompts/mod.rs`, `LlmProvider`, `validate.rs`, `Self`, `empty_completion_remedy`, `ProviderError`, `error.rs`, `orchestrator.rs`, `validate_prompt_for`, `.external`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `SpyProxy` connect `proxy.rs` to `runner.rs`, `run`, `preflight.rs`, `MagiError`?**
