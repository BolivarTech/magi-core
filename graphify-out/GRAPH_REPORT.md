...
## Corpus Check
- 177 files · ~313,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3405 nodes · 7606 edges · 429 communities (187 shown, 242 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6cc4d682`
...
## Communities (429 total, 242 thin omitted)
...
### Community 4 - ".new"
Cohesion: 0.10
Nodes (56): a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), report_with_one_failing_agent(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet() (+48 more)

### Community 5 - "Completion"
Cohesion: 0.13
Nodes (16): Deserialize, Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), Completion, CompletionTelemetry, finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary(), FinishReason (+8 more)
...
Cohesion: 0.11
Nodes (18): a_native_empty_without_the_footprint_falls_back_to_empty_completion(), done_reason_body(), into_completion_carries_a_measured_reasoning_trace_when_present(), into_completion_carries_the_telemetry_of_a_real_success(), is_crate_defect(), native_empty_with_counters(), native_error(), native_error_falls_back_to_the_raw_body_when_it_does_not_parse_as_native_error() (+10 more)
...
### Community 21 - "main"
Cohesion: 0.20
Nodes (19): CycleRun, I, Output, build_outcome(), Cli, crate_version(), cycle_run(), git_commit() (+11 more)

### Community 22 - "String"
Cohesion: 0.08
Nodes (49): Agent, AgentFactory, Arc, Completion, CompletionConfig, CompletionRecord, ConsensusEngine, CrateDefectRecord (+41 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.10
Nodes (25): Box, ComplexityGate, ConsensusConfig, FallbackPool, Lineage, LlmProvider, Mode, P (+17 more)

### Community 24 - "proxy.rs"
Cohesion: 0.06
Nodes (55): AtomicBool, B, Bytes, X, Client, HeaderMap, Incoming, Infallible (+47 more)

### Community 25 - "Finding"
Cohesion: 0.17
...
### Community 44 - "redaction_negative.rs"
Cohesion: 0.37
...
Cohesion: 0.05
Nodes (77): DedupFinding, Dissent, a_clean_run_gains_no_section_at_all(), a_fresh_record_measures_nothing_and_says_so(), a_recorded_cut_is_not_an_extraction_failure(), a_report_from_before_this_version_also_gains_nothing(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key() (+69 more)
...
Cohesion: 0.10
Nodes (27): AssertionRow, CostLedger, a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero(), a_run_that_could_not_start_is_never_a_verdict_about_the_crate(), a_scenario_filtered_out_by_no_backend_is_OUT_OF_SCOPE_not_omitted(), a_scenario_reading_one_run_never_sees_ANOTHER_runs_records(), absent_context() (+19 more)
...
Cohesion: 0.19
Nodes (14): Fallback, Injection, Payload, ReasoningControl, RunOutcome, Seat, attempts_for(), build_magi_against() (+6 more)
...
Cohesion: 0.16
Nodes (21): AgentName, AgentOutput, AgentRotation, BTreeMap, Condition, ConsensusResult, default_rotations(), resolve_crate_defect() (+13 more)
...
Cohesion: 0.06
Nodes (38): Announcement, AsRef, Deref, PreflightError, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), no_backend_skips_the_backend_steps_and_nothing_else(), AlwaysSlowStub, block_comment_depth_after() (+30 more)
...
### Community 165 - "run"
Cohesion: 0.09
Nodes (38): Debug, Field, FixtureSummary, a_backend_listing_the_whole_trio_gets_past_the_backend_step(), a_listing_larger_than_the_cap_is_not_held_in_memory(), a_probe_that_is_slow_names_both_possible_causes(), Announcement, audit_published_package() (+30 more)
...
Cohesion: 0.06
Nodes (53): Drop, FnOnce, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused(), a_file_that_omits_seats_and_fallbacks_gets_the_built_in_ones(), a_file_value_an_override_rescues_is_judged_on_the_final_set_not_the_file_alone(), a_set_of_overrides_that_is_still_illegal_at_the_end_is_refused() (+45 more)
...
### Community 222 - ".new"
Cohesion: 0.24
Nodes (23): test_base_zero_with_three_retries_emits_exactly_four_requests(), test_budget_exhaustion_abandons_with_typed_reason(), test_dangerous_config_is_announced_for_retry_after_cap_over_budget(), test_dangerous_config_is_announced_for_zero_base_delay(), test_dangerous_config_is_announced_for_zero_cap(), test_dangerous_config_is_announced_for_zero_retry_after_cap(), test_honored_retry_after_can_overrun_a_small_budget(), test_max_retries_zero_does_not_retry() (+15 more)

### Community 224 - "compose_transport_message"
Cohesion: 0.50
Nodes (3): Error, String, spawn_failure()

### Community 228 - "provider.rs"
Cohesion: 0.05
Nodes (27): f(), f(), f(), f(), a_refused_redirect_is_mage_local_and_never_retried(), cause_chain(), cause_chain_skips_the_top_level_error(), completion_new_takes_only_the_mandatory_field() (+19 more)
...
### Community 298 - "SlowFailingProvider"
Cohesion: 0.25
...
Cohesion: 0.12
Nodes (13): a_timed_out_run_reports_its_cap_verbatim(), BackendNeed, classify_error(), ErrorClass, Scenario, Source, the_announced_runs_are_the_runs_this_stage_actually_launches(), the_degradation_run_has_no_pool_so_the_seat_actually_degrades() (+5 more)
...
### Community 330 - "Error"
Cohesion: 0.14
Nodes (12): Error, Ok, RetryClass, S, chat_request(), classify(), client_build_error(), every_contract_variant_has_its_own_retry_class() (+4 more)
...
- **Why does `ProviderError` connect `ProviderError` to `rotation.rs`, `validate.rs`, `provider_url.rs`, `LlmProvider`, `CompletionConfig`, `build_retry_prompt`, `e2.rs`, `AlwaysFailsExternally`, `error.rs`, `Duration`, `ProviderResponse`, `.redacted`, `String`, `.parse`, `HostedModel`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `MagiError` connect `validate.rs` to `AgentName`, `consensus.rs`, `prompts/mod.rs`, `LlmProvider`, `Error`, `ProviderError`, `e2.rs`, `error.rs`, `String`, `MagiBuilder`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `LlmProvider` connect `LlmProvider` to `test_support.rs`, `provider.rs`, `MockProvider`, `Completion`, `CompletionConfig`, `claude.rs`, `Error`, `SlowFailingProvider`, `claude_cli.rs`, `basic_analysis.rs`, `AlwaysFailsExternally`, `OllamaProvider`, `openai_compat.rs`, `MagiBuilder`, `proxy.rs`, `HostedModel`, `.new`?**
