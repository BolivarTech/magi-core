...
## Corpus Check
- 103 files · ~127,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2064 nodes · 4554 edges · 237 communities (130 shown, 107 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3321d94`
...
## Communities (237 total, 107 thin omitted)

### Community 0 - "orchestrator.rs"
Cohesion: 0.08
Nodes (63): AgentOutput, ExtractionFailureCause, a_threshold_that_can_never_fire_is_detected(), a_zero_threshold_warns_always_and_does_not_disable(), an_empty_input_never_exceeds_even_a_zero_threshold(), dispatch_one_agent(), echoed_example_response(), exceeding_the_threshold_warns_and_still_completes() (+55 more)
...
Cohesion: 0.15
Nodes (12): X, ProviderError, Result, X, Response, diagnostic_truncation_is_announced_and_utf8_safe(), diagnostic_under_the_cap_is_untouched(), ProviderResponse (+4 more)
...
### Community 17 - ".new"
Cohesion: 0.07
Nodes (52): AgentName, BTreeSet, Default, HashMap, Lineage, Magi, MagiReport, Mutex (+44 more)
...
### Community 23 - ".cmp"
Cohesion: 0.10
Nodes (19): Box, P, String, ComplexityGate, ConsensusConfig, FallbackPool, PathBuf, ReportConfig (+11 more)
...
Cohesion: 0.12
Nodes (34): AbortHandle, Agent, AgentFactory, AgentRotation, BTreeMap, ConsensusEngine, DispatchOutcome, Drop (+26 more)
...
Cohesion: 0.07
Nodes (41): describe(), main(), MyBackend, ProviderError, Result, String, Send, Agent (+33 more)
...
Cohesion: 0.19
Nodes (6): Arc, AtomicU32, RetryClass, MockProvider, RetryConfig, RetryProvider
...
Cohesion: 0.18
Nodes (8): classify(), FailingProvider, is_retryable(), RetryAfterProvider, ProviderError, Result, String, Vec
...
Cohesion: 0.09
Nodes (19): Error, Mode, cause_chain(), cause_chain_skips_the_top_level_error(), client_build_error(), default_model_for_mode(), describe_parse_error(), resolve_claude_alias() (+11 more)
...
Cohesion: 0.18
Nodes (8): f(), f(), f(), compose_caps_the_head_even_with_no_cause_chain(), compose_does_not_truncate_when_under_the_cap(), compose_never_panics_on_multibyte_boundaries(), compose_puts_operation_and_url_first_and_truncates_the_cause_tail(), compose_transport_message()
...
Cohesion: 0.40
Nodes (3): ProviderError, Result, body_cap()
...
- **Why does `LlmProvider` connect `[0.3.0] - 2026-04-18` to `orchestrator.rs`, `Finding`, `Duration`, `7. Design Philosophy`, `.new`, `error.rs`, `claude.rs`, `MockProvider`, `FallbackPool`, `claude_cli.rs`, `mod.rs`, `RoutingMockProvider`, `Instant`, `.cmp`, `dispatch_one_agent`, `LlmProvider`, `String`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `OpenAiCompatibleProvider` connect `Instant` to `[0.3.0] - 2026-04-18`, `4. Library Architecture`, `finding_id.rs`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `OllamaProvider` connect `finding_id.rs` to `4. Library Architecture`, `RoutingMockProvider`?**
