...
## Corpus Check
- 177 files · ~314,584 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3409 nodes · 7625 edges · 413 communities (189 shown, 224 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3a13700`
...
## Communities (413 total, 224 thin omitted)

### Community 0 - "test_support.rs"
Cohesion: 0.06
Nodes (50): HashMap, Lineage, Magi, Beh, build_oversized_case(), build_schema_local_case(), build_trio_with_caspar(), build_two_5xx_with_local_fallbacks() (+42 more)
...
### Community 4 - ".analyze"
Cohesion: 0.08
Nodes (49): FallbackPool, a_completion_record_is_built_in_exactly_one_place(), a_completion_that_failed_is_recorded_too(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet() (+41 more)

### Community 5 - "Self"
Cohesion: 0.15
Nodes (11): Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), CompletionTelemetry, finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary(), FinishReason, ReasoningState, Option (+3 more)
...
Cohesion: 0.09
Nodes (41): ClaudeMessage, ClaudeProvider, ClaudeRequest, ClaudeResponse, ClaudeUsage, ContentBlock, map_stop_reason(), Client (+33 more)
...
Cohesion: 0.06
Nodes (47): Config, Duration, Fallback, Injection, MagiError, Payload, PayloadError, ReasoningControl (+39 more)

### Community 18 - "orchestrator.rs"
Cohesion: 0.06
Nodes (79): AbortHandle, CrateDefectRecord, Elapsed, ExtractionFailureCause, InputSize, a_crate_defect_records_nothing_because_its_report_will_not_exist(), a_probe_declaring_another_model_is_named_not_rejected(), a_probe_declaring_its_own_model_is_quiet() (+71 more)
...
### Community 22 - "String"
Cohesion: 0.12
Nodes (40): Agent, AgentFactory, BTreeMap, CompletionRecord, ConsensusEngine, DispatchOutcome, ExtractionFailure, JoinError (+32 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.12
Nodes (19): Box, ComplexityGate, ConsensusConfig, P, ProviderProbe, ReportConfig, RngLike, Send (+11 more)
...
Cohesion: 0.07
Nodes (24): DedupFinding, a_fresh_record_measures_nothing_and_says_so(), a_recorded_cut_is_not_an_extraction_failure(), a_report_from_the_previous_version_deserializes_as_none_not_zero(), a_report_with_no_completions_at_all_carries_no_key(), an_older_report_without_the_field_still_deserializes(), cause_label(), estimate_tokens() (+16 more)
...
### Community 40 - "Result"
Cohesion: 0.22
Nodes (5): Completion, CompletionConfig, DeclaringProbe, MockProvider, Result
...
Cohesion: 0.06
Nodes (16): Display, Formatter, a_message_of_exactly_the_cap_is_kept_whole(), a_short_external_message_survives_untouched(), AbandonReason, an_oversized_external_message_is_cut_and_says_so(), external_message(), ResponseContractCause (+8 more)
...
### Community 67 - ".new"
Cohesion: 0.28
Nodes (13): Future, a_receipt_BEFORE_the_runs_is_refused_even_though_the_estimate_was_announced(), a_receipt_is_refused_when_the_intervals_do_not_MATCH_the_announced_runs(), a_run_that_ends_badly_is_still_measured_so_the_receipt_is_not_withheld(), backend_runs_of(), CostLedger, Default, Self (+5 more)

### Community 68 - "MagiError"
Cohesion: 0.14
Nodes (18): From, MagiError, AgentName, Lineage, Mode, Option, Vec, clean_title() (+10 more)

### Community 69 - "MockProvider"
Cohesion: 0.13
Nodes (10): AtomicU32, Default, RetryClass, classify(), every_contract_variant_has_its_own_retry_class(), MockProvider, RetryAfterProvider, RetryConfig (+2 more)
...
Cohesion: 0.20
Nodes (7): Debug, Field, Announcement, preflight_step_order(), Formatter, SpyProxy, the_order_is_config_then_fixtures_then_backend()
...
### Community 104 - "LlmProvider"
Cohesion: 0.08
Nodes (11): AtomicUsize, describe(), main(), MinimalProvider, MyBackend, String, AlwaysFailsExternally, FailingProvider (+3 more)
...
### Community 121 - "Arc"
Cohesion: 0.19
Nodes (6): Arc, HostedModel, Option, Result, String, SidecarProbe
...
Cohesion: 0.08
Nodes (32): Announcement, PreflightError, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), no_backend_skips_the_backend_steps_and_nothing_else(), AlwaysSlowStub, block_comment_depth_after(), BulkStub, EchoServer (+24 more)
...
Cohesion: 0.15
Nodes (29): Config, a_probe_that_is_slow_names_both_possible_causes(), audit_published_package(), check_lock_is_tracked(), check_seat_models(), check_workspace_isolation(), harness_files_in_listing(), listed_models() (+21 more)
...
### Community 174 - "announce_cost"
Cohesion: 0.36
Nodes (7): RunId, announce_cost(), is_large_payload(), payload_bytes_for(), the_announced_cost_counts_every_seat_and_both_sides_of_the_wire(), the_cost_announced_is_the_cost_of_the_runs_that_will_actually_happen(), stage_e1_run_ids()

### Community 177 - "provider.rs"
Cohesion: 0.05
Nodes (30): f(), f(), f(), f(), Error, Mode, a_refused_redirect_is_mage_local_and_never_retried(), cause_chain() (+22 more)
...
Cohesion: 0.05
Nodes (54): Deserialize, Drop, FnOnce, Into, Self, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused() (+46 more)
...
### Community 218 - ".format_init_banner"
Cohesion: 0.50
...
Cohesion: 0.14
Nodes (13): Barrier, Instant, ProviderError, FailingProbe, MockProbe, OverlapProbe, ProviderProbe, AtomicUsize (+5 more)
...
### Community 330 - "Completion"
Cohesion: 0.17
Nodes (11): Result, Ok, S, Result, Result, Completion, CompletionConfig, is_retryable() (+3 more)
...
- **Why does `ProviderError` connect `ProviderError` to `rotation.rs`, `MagiError`, `.analyze`, `provider_url.rs`, `LlmProvider`, `build_retry_prompt`, `Completion`, `Result`, `error.rs`, `ProviderResponse`, `orchestrator.rs`, `.redacted`, `String`, `.parse`, `Arc`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `LlmProvider` connect `LlmProvider` to `.new`, `MockProvider`, `agent.rs`, `ollama_wire.rs`, `claude.rs`, `Completion`, `claude_cli.rs`, `basic_analysis.rs`, `provider.rs`, `openai_compat.rs`, `MagiBuilder`, `proxy.rs`, `Arc`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `MagiError` connect `MagiError` to `prompts/mod.rs`, `consensus.rs`, `validate.rs`, `.analyze`, `agent.rs`, `ProviderError`, `error.rs`, `provider.rs`, `orchestrator.rs`, `String`?**
