...
## Corpus Check
- 161 files · ~223,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2863 nodes · 6481 edges · 301 communities (186 shown, 115 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32ab8fc9`
...
## Communities (301 total, 115 thin omitted)

### Community 0 - "RunResult"
Cohesion: 0.33
Nodes (11): AgentName, MagiReport, Option, RequestRecord, RunId, String, Vec, RunContext (+3 more)
...
### Community 4 - ".analyze"
Cohesion: 0.10
Nodes (39): a_measured_candidate_keeps_the_strict_guard_quiet(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet(), F, staying_under_the_threshold_announces_nothing(), test_a_clean_run_adds_no_section_to_the_human_report() (+31 more)
...
### Community 6 - "CompletionConfig"
Cohesion: 0.10
Nodes (30): AgentFactory, MockProvider, AtomicUsize, BTreeMap, Default, Option, Path, ProviderError (+22 more)
...
Cohesion: 0.09
Nodes (24): ComplexityGate, contract_prompt(), MagiBuilder, Box, P, Self, Send, test_analyze_applies_mode_agnostic_override_to_melchior() (+16 more)
...
### Community 25 - "Magi"
Cohesion: 0.08
Nodes (40): AbortHandle, DispatchOutcome, JoinError, ExternalErrorKind, AbortGuard, an_oversized_response_routes_to_its_own_mage_local_outcome(), attempt_model(), CapturingMockProvider (+32 more)
...
### Community 66 - "RunSpec"
Cohesion: 0.24
Nodes (10): Fallback, Injection, Magi, Payload, Seat, build_magi_against(), injected_agent(), ProviderKind (+2 more)

### Community 67 - "compose_transport_message"
Cohesion: 0.12
...
### Community 76 - "e1.rs"
Cohesion: 0.06
Nodes (100): MagiReport, RequestRecord, RunContext, sha256_hex(), assert_that(), a_fired_injection(), answered_probes(), blank_ctx() (+92 more)
...
Cohesion: 0.08
Nodes (14): F, a_panic_inside_a_run_is_caught_and_attributed_instead_of_killing_the_harness(), a_run_that_finishes_is_returned_untouched(), classify_panic(), exit_code(), install_panic_hook(), is_dependency_source(), is_harness_source() (+6 more)
...
Cohesion: 0.07
Nodes (43): AtomicBool, B, Box, Bytes, X, Client, HeaderMap, Incoming (+35 more)

### Community 180 - "LlmProvider"
Cohesion: 0.27
Nodes (6): Agent, Arc, Self, LlmProvider, Send, Sync
...
### Community 191 - "preflight.rs"
Cohesion: 0.18
Nodes (14): a_probe_that_is_slow_names_both_possible_causes(), announce_cost(), check_lock_is_tracked(), pid_is_alive(), preflight_step_order(), probe_failure_message(), Path, sweep_stale_temps() (+6 more)
...
### Community 194 - "run"
Cohesion: 0.21
Nodes (18): Config, Debug, Display, Duration, Formatter, Into, Announcement, check_workspace_isolation() (+10 more)
...
Cohesion: 0.11
Nodes (33): AssertionRow, BuildOutcome, CycleRun, RunId, RunResult, Scenario, a_genuine_skip_still_reports_exit_two(), a_healthy_run_can_reach_exit_zero() (+25 more)
...
### Community 222 - "FixtureSummary"
Cohesion: 0.29
Nodes (4): FixtureSummary, Option, the_end_of_run_count_names_both_classes(), the_thirty_percent_warning_fires_only_strictly_above_the_threshold()

### Community 224 - "compose_transport_message"
Cohesion: 0.50
Nodes (3): Error, String, spawn_failure()

### Community 225 - "Assertion"
Cohesion: 0.40
Nodes (4): Self, an_assertion_that_could_not_be_tested_carries_its_reason(), Assertion, Into
...
### Community 237 - "Error"
Cohesion: 0.50
Nodes (3): Error, Result, show_request()

### Community 239 - "[1.1.0] - 2026-05-25"
Cohesion: 0.67
Nodes (3): [1.1.0] - 2026-05-25, Added, Notes

### Community 249 - "symlinks_are_skipped"
Cohesion: 0.50
Nodes (4): symlinks_are_skipped(), is_privilege_refusal(), make_symlink(), Error
...
Cohesion: 0.11
Nodes (22): Arc, AtomicUsize, Mutex, a_broken_proxy_makes_the_preflight_say_cannot_test_not_failed(), a_cold_model_passes_on_the_second_probe_attempt(), an_endpoint_slow_every_time_still_reports_cannot_test(), no_backend_skips_the_backend_steps_and_nothing_else(), AlwaysSlowStub (+14 more)
...
### Community 310 - "PathBuf"
Cohesion: 0.22
Nodes (9): PathBuf, the_backend_step_and_the_probe_step_ask_different_questions(), the_contention_probe_sends_a_real_completion_not_a_manifest_listing(), fresh_temp_dir(), repo_where_the_negation_was_removed(), Path, stub_that_records_requests(), temp_root_with() (+1 more)
...
- **Why does `LlmProvider` connect `LlmProvider` to `RetryAfterProvider`, `.analyze`, `MockProvider`, `CompletionConfig`, `ProviderProbe`, `claude.rs`, `claude_cli.rs`, `test_support.rs`, `orchestrator.rs`, `ollama.rs`, `MagiBuilder`, `.new`, `Magi`, `FallbackPool`, `basic_analysis.rs`, `.complete`, `SlowFailingProvider`, `provider.rs`, `rotation.rs`, `ProviderError`, `HostedModel`, `Instant`, `.new`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `run_catching()` connect `outcome.rs` to `RunSpec`, `Self`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `ProviderRequest` connect `ProviderRequest` to `ProviderResponse`, `provider_url.rs`, `Self`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
