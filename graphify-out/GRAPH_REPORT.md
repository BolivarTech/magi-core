# Graph Report - MAGI-Core  (2026-09-05)

## Corpus Check
- 204 files · ~699,320 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3926 nodes · 8690 edges · 277 communities (230 shown, 47 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6751d223`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- test_support.rs
- 0. Estándares obligatorios — INLINE, no referenciados
- consensus.rs
- validate.rs
- .build
- run
...
- 0. Estándares obligatorios — INLINE, no referenciados
- Files
- MS1 — Clasificación de fallos (plan TDD)
- Debug
- Report
- Formatter
- ProviderError
...
- SlowFailingProvider
- MS1.md
- MS1 — Clasificación de fallos
- build.py
- Cierre de MS0 — lo específico
- preflight.rs
- provider_url.rs
- AgentName
...
- .new
- git.rs
- Task: translate Rust code comments from Spanish to English
- MS0.md
- body_bounds.rs
- _verify_xlate.py
- AssertionRow
- .render_human
- R-1 — diseño compartido de las Tasks 3a y 3 · **INLINE (Opus)**
- claude.rs
- [1.1.1] - 2026-07-17
- [2.2.0] - 2026-07-27
...
### Community 1 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.04
Nodes (45): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+37 more)
...
### Community 4 - ".build"
Cohesion: 0.10
Nodes (46): a_completion_that_failed_is_recorded_too(), a_mage_local_failure_does_not_condemn_the_lineage_for_the_other_seats(), a_measured_candidate_keeps_the_strict_guard_quiet(), a_run_with_no_cuts_still_records_one_entry_per_completion(), a_strict_guard_with_nothing_measured_warns_and_still_completes(), exceeding_the_threshold_warns_and_still_completes(), probe_declaration_warnings_are_told_once_per_instance(), rotation_disabled_by_configuration_keeps_the_strict_guard_quiet() (+38 more)
...
### Community 19 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.04
Nodes (45): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+37 more)
...
Cohesion: 0.10
Nodes (20): Serialize, an_external_implementor_can_report_real_telemetry_not_only_unmeasured(), BudgetBearing, Completion, CompletionTelemetry, elided(), finish_reason_keeps_an_unknown_wire_value_instead_of_dropping_it(), finish_reason_other_is_capped_at_64_chars_on_a_char_boundary() (+12 more)

### Community 23 - "MagiBuilder"
Cohesion: 0.08
Nodes (29): ComplexityGate, build_with(), build_with_honours_the_three_values_it_takes(), contract_prompt(), it_never_returns_err_no_matter_how_absurd_the_configuration(), Magi, MagiBuilder, AtomicBool (+21 more)
...
### Community 40 - "Runner"
Cohesion: 0.20
Nodes (13): build_with_absurd_timings(), chat_request(), ErosionProbe, probe_is_in_scope(), probe_window(), Duration, Error, Path (+5 more)
...
### Community 43 - "e2.rs"
Cohesion: 0.08
Nodes (52): assert_that(), Assertion, analyze_produced_a_report(), the_crate_correctly_reporting_a_dead_backend_is_not_a_verdict(), content_failure_detail(), e2_scenarios(), erosion_ctx(), r17_fails_rather_than_passing_vacuously_when_nothing_was_measured() (+44 more)
...
Cohesion: 0.27
Nodes (14): BackendNeed, RunContext, Scenario, Source, f_scenarios(), no_timings_skips_instead_of_passing(), Vec, s_f1() (+6 more)
...
Cohesion: 0.20
Nodes (20): FnMut, fixed(), next_backoff(), RetryClass, Option, sanitize(), test_base_zero_yields_zero_wait(), test_boundary_table_honors_retry_after_exactly() (+12 more)
...
Cohesion: 0.17
Nodes (11): Ord, Ordering, PartialOrd, Finding, Display, Into, Option, Self (+3 more)
...
Cohesion: 0.11
Nodes (14): SessionFacts, a_timed_out_run_reports_its_cap_verbatim(), cannot_test_is_a_skip_with_a_reason_not_a_silent_empty_result(), classify_error(), ErrorClass, shipped_timings(), the_announced_runs_are_the_runs_this_stage_actually_launches(), the_degradation_run_has_no_pool_so_the_seat_actually_degrades() (+6 more)

### Community 69 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.04
Nodes (44): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+36 more)
...
### Community 78 - "CompletionConfig"
Cohesion: 0.09
Nodes (12): describe(), main(), MinimalProvider, MyBackend, ProviderError, Result, String, AlwaysFailsExternally (+4 more)
...
### Community 84 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.05
Nodes (43): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+35 more)

### Community 85 - "s15_degradation_is_honest"
Cohesion: 0.21
Nodes (21): a_fired_injection(), render_combinations(), report_from(), Into, Option, String, s15_ctx(), s15_degradation_is_honest() (+13 more)
...
### Community 89 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.05
Nodes (39): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+31 more)
...
### Community 91 - "selfaudit.py"
Cohesion: 0.09
Nodes (39): audit(), code_blocks(), collect_created(), main(), prose_lines(), r_attribute_claims(), r_balanced_delimiters(), r_bare_symbols() (+31 more)

### Community 92 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.06
Nodes (31): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+23 more)

### Community 94 - "coherence.py"
Cohesion: 0.13
Nodes (25): check_citations(), check_counts(), check_prohibitions(), check_req_placement(), check_signature_consistency(), check_stale_escalations(), check_step_refs(), main() (+17 more)

### Community 95 - "precheck.py"
Cohesion: 0.14
Nodes (25): _balanced(), check_arity(), check_collision(), check_counts(), check_duplabel(), check_enums(), check_shadow(), check_symbols() (+17 more)

### Community 96 - "Result"
Cohesion: 0.12
Nodes (15): a_hanging_seat_degrades_the_run_within_the_given_ceiling(), an_oversized_response_routes_to_its_own_mage_local_outcome(), crate_defect_of(), DeclaringProbe, each_contract_variant_gets_the_consequence_the_spec_assigned(), every_external_shape_routes_to_its_own_mage_local_outcome(), is_connection(), MockProvider (+7 more)

### Community 97 - "Validator"
Cohesion: 0.20
Nodes (11): clean_title(), Default, Result, Self, String, test_clean_title_is_idempotent(), test_title_length_checked_after_strip_zero_width(), test_validate_mut_atomic_no_partial_mutation_on_error() (+3 more)

### Community 98 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.13
Nodes (15): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+7 more)

### Community 99 - "0. Estándares obligatorios — INLINE, no referenciados"
Cohesion: 0.13
Nodes (15): 0.10 Gates — la lista autoritativa, 0.11 Git, 0.12 Formato de salida — aplica a lo que produce un SUBAGENTE o `/ollama`, 0.13 Restricciones globales de este release, 0.14 Decisiones de diseño CERRADAS que gobiernan este milestone, 0.1 Paradigma y calidad, 0.2 Manejo de errores, 0.3 Memoria y recursos (+7 more)

### Community 100 - "Files"
Cohesion: 0.15
Nodes (13): Files, Task 0: corregir el alcance de `4.0.1` en `CLAUDE.md` — **DÍA UNO** · **INLINE (Opus)**, Task 10: el piso mecánico de las 14 divulgaciones del CHANGELOG (spec §2 punto 9b) · **INLINE (Opus)**, Task 1: R-35 — guarda de redacción de fixtures · **INLINE (Opus)**, Task 2: R-28 — armar el self-test de `check_pending.sh` y arreglar su auto-invocación · **Sonnet**, Task 3: R-29 — raíz ausente no reporta OK · **`/ollama`**, Task 4: R-32 — qué va en el paquete · **Sonnet**, Task 5: R-30 — el modo `published` deja de mentir · **PARTIDA EN 5a / 5b** (+5 more)

### Community 101 - "MS1 — Clasificación de fallos (plan TDD)"
Cohesion: 0.17
Nodes (12): Cierre de MS1 — lo específico, Dimensionamiento — porque §1.1 no puede dispararse sobre un atraso que nadie ve, Files, MS1 — Clasificación de fallos (plan TDD), MS1 toca `orchestrator.rs`, que es archivo primario de MS3 — nota de coordinación, R-17 y R-20 — SON DE MS1, y su aceptación se evalúa en el gate de MS1, Rechazos y falsos positivos del Checkpoint 2 — con su razón, Task 0 — PRECONDICIÓN DE DESPACHO. No es una tarea TDD y no produce código. (+4 more)
...
### Community 132 - "1. Alcance y estructura"
Cohesion: 0.20
Nodes (10): 1.0 Topología de ramas — CADENA APILADA (usuario, 2026-09-03), 1.1 Si un milestone se traba — reglas operativas, 1. Alcance y estructura, 1. CONTEXTO COMPARTIDO (spec §1, §2, §4, §5), 2. Restricciones, 4. Lo que este trabajo NO debe hacer, 5. Prerrequisitos y huecos declarados, Criterios de cierre comunes a TODO milestone (+2 more)
...
### Community 144 - "s2b_the_proxy_is_transparent"
Cohesion: 0.38
Nodes (10): sha256_hex(), record(), recorded_response(), s2b_fails_when_the_recorded_request_body_hash_disagrees(), s2b_fails_when_the_relayed_status_differs_from_the_one_the_backend_gave(), s2b_passes_when_both_hashes_and_the_status_match(), s2b_skips_when_the_direct_half_left_no_status_to_compare_against(), s2b_skips_when_the_probe_never_completed() (+2 more)
...
### Community 168 - "MS0 — Mecánica de gate"
Cohesion: 0.22
Nodes (9): Cierre de MS0, MS0 — Mecánica de gate, R-28 · El self-test de `check_pending.sh` queda armado, R-29 · `check_prose_artifacts.sh` no reporta OK sobre un set de scan VACÍO, R-30 · El modo `published` del harness deja de mentir, R-31 · Un chequeo de que el README y `Cargo.toml` concuerdan en el major, R-32 · Se decide qué va en el paquete: `tests/` y `.github/`, R-34 · Un chequeo mecánico de que los encabezados están sincronizados (+1 more)

### Community 173 - "F"
Cohesion: 0.67
Nodes (3): Architecture, Module Dependency Graph, Prompt Injection Defense

### Community 174 - "SlowFailingProvider"
Cohesion: 0.25
Nodes (3): AtomicUsize, Duration, SlowFailingProvider

### Community 176 - "MS1.md"
Cohesion: 0.25
Nodes (7): 1. CONTEXTO COMPARTIDO (spec §1, §2, §4, §5), 2. Restricciones, 2. SPEC — MS1, 3. PLAN TDD — MS1, 4. Lo que este trabajo NO debe hacer, 5. Prerrequisitos y huecos declarados, CHECKPOINT 2 — MS1

### Community 177 - "MS1 — Clasificación de fallos"
Cohesion: 0.25
Nodes (8): Cierre de MS1, MS1 — Clasificación de fallos, R-11 · Una sola implementación de la truncación con marcador, R-17 · Sin `unreachable!()` en código de producción, R-19 · La tabla de statuses transitorios tiene una sola fuente, R-1 · Un retry abandonado no puede condenar run-wide una falla mage-local, R-20 · `execute` delega en `execute_with`, R-2 · `529` (Anthropic `overloaded_error`) es transitorio

### Community 179 - "build.py"
Cohesion: 0.43
Nodes (6): build(), main(), Return the ``### MSn`` section of the spec, up to the next ``### MS``. Fails…, Return spec sections 1, 2, 4 and 5, concatenated in that order. Fails loudly if…, shared_context(), spec_section()

### Community 180 - "Cierre de MS0 — lo específico"
Cohesion: 0.29
Nodes (7): Cierre de MS0 — lo específico, Cuatro recomendaciones RECHAZADAS, con su razón — no diferidas en silencio, Dos ítems de backlog que salen de esta decisión, El residual ACEPTADO, y quién lo firmó, Tres FALSOS POSITIVOS, verificados contra el texto del plan, Tres más rechazadas en la vuelta siguiente, Un INFO rechazado: los tags de pre-release
...
### Community 191 - "parse_retry_after"
Cohesion: 0.38
Nodes (7): parse_retry_after(), RetryAfter, Duration, String, Vec, test_parse_retry_after_never_panics(), v()

### Community 192 - "MagiReport"
Cohesion: 0.16
Nodes (17): ExtractionFailure, InputSize, MagiReport, ReportConfig, ReportError, ReportFormatter, BTreeMap, BTreeSet (+9 more)
...
Cohesion: 0.06
Nodes (52): Deserialize, FnOnce, a_budget_beyond_the_ceiling_is_rejected_and_the_field_is_named(), a_correctly_spelled_override_still_loads(), a_file_that_is_still_illegal_once_every_override_is_applied_is_refused(), a_file_that_omits_seats_and_fallbacks_gets_the_built_in_ones(), a_file_value_an_override_rescues_is_judged_on_the_final_set_not_the_file_alone(), a_set_of_overrides_that_is_still_illegal_at_the_end_is_refused() (+44 more)

### Community 197 - "mark_removable.py"
Cohesion: 0.47
Nodes (5): in_code(), main(), paragraph(), Indice booleano: True donde la linea vive dentro de un bloque de codigo., Limites del parrafo que contiene la linea `i` (0-indexed). Un parrafo termina…
...
### Community 199 - "RunId"
Cohesion: 0.17
Nodes (16): Fallback, RunId, run_with(), RunOutcome, attempts_for(), build_magi_against(), injected_agent(), ProviderKind (+8 more)

### Community 200 - "1. Alcance y estructura"
Cohesion: 0.33
Nodes (6): 1.0 Topología de ramas — CADENA APILADA (usuario, 2026-09-03), 1.1 Si un milestone se traba — reglas operativas, 1. Alcance y estructura, Criterios de cierre comunes a TODO milestone, El corte y su orden, Mecanismos compartidos, diseñados una vez

### Community 204 - "git.rs"
Cohesion: 0.33
Nodes (4): Path, Result, String, status_porcelain()

### Community 209 - "Task: translate Rust code comments from Spanish to English"
Cohesion: 0.33
Nodes (5): Input, Output format, Rules — these are the contract, not suggestions, Task: translate Rust code comments from Spanish to English, Why this matters

### Community 210 - "MS0.md"
Cohesion: 0.40
Nodes (4): 2. SPEC — MS0, 3. PLAN TDD — MS0, CHECKPOINT 2 — MS0, MS0 — Mecánica de gate (plan TDD)
...
### Community 212 - "_verify_xlate.py"
Cohesion: 0.60
Nodes (4): code_part(), main(), Lo que NO es prosa. Con `//` la prosa es todo lo que sigue; sin el, la prosa…, read()
...
### Community 216 - "R-1 — diseño compartido de las Tasks 3a y 3 · **INLINE (Opus)**"
Cohesion: 0.50
Nodes (4): R-1 — diseño compartido de las Tasks 3a y 3 · **INLINE (Opus)**, Task 3-cierre: las verificaciones y las mutaciones de R-1 · **INLINE (Opus)**, Task 3: R-1 — un retry abandonado no condena run-wide · **INLINE (Opus)**, Task 3a: la CARACTERIZACIÓN de `provider_err_outcome` · **INLINE (Opus)**
...
### Community 218 - "[1.1.1] - 2026-07-17"
Cohesion: 0.67
Nodes (3): [1.1.1] - 2026-07-17, Changed, Fixed

### Community 219 - "[2.2.0] - 2026-07-27"
Cohesion: 0.67
...
Cohesion: 0.40
Nodes (4): test_new_checked_accepts_all_ascii_titles(), test_new_checked_rejects_banner_width_too_small(), test_new_checked_rejects_non_ascii_display_name(), test_new_checked_rejects_non_ascii_title_field()
...
Cohesion: 0.12
Nodes (18): Ok, S, cause_chain(), cause_chain_skips_the_top_level_error(), classify(), client_build_error(), every_contract_variant_has_its_own_retry_class(), FailingProvider (+10 more)

### Community 283 - "e1.rs"
Cohesion: 0.07
Nodes (57): a_typed_crate_failure_is_a_verdict_about_the_crate(), an_unclassified_failure_is_read_as_the_crate_s(), answered_probes(), blank_ctx(), e1_contains_exactly_the_scenarios_valid_against_3_2_0(), e1_scenarios(), preflight_error_for_stage(), Result (+49 more)

### Community 289 - "rotation.rs"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (36): AbortHandle, DispatchOutcome, JoinError, ExternalErrorKind, MagiError, From, a_mage_local_rotation_detail_says_what_happened_and_not_its_scope(), AbortGuard (+28 more)
...
## Knowledge Gaps
- **525 isolated node(s):** `magi-core`, `check_packaged_consumer.sh script`, `check_r0.sh script`, `ProviderError`, `ProviderError` (+520 more)
...
- **Why does `AgentName` connect `AgentName` to `test_support.rs`, `consensus.rs`, `.build`, `LlmProvider`, `schema.rs`, `orchestrator.rs`, `MagiBuilder`, `.new`, `rotation.rs`, `String`, `.new`, `embedded_prompt_for`, `RunContext`, `MagiReport`, `prompts/mod.rs`, `Finding`, `config.rs`, `RunId`, `LineageRegistry`, `AgentOutput`, `Result`, `.new_checked`, `ProviderProbe`, `ConsensusResult`, `FallbackPool`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `MagiError` connect `AgentName` to `Result`, `prompts/mod.rs`, `consensus.rs`, `validate.rs`, `runner.rs`, `.build`, `LlmProvider`, `RunId`, `build_user_prompt`, `orchestrator.rs`, `user_prompt.rs`, `Validator`, `error.rs`, `Lineage`, `body_bounds.rs`, `MagiBuilder`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Config` connect `Config` to `config.rs`, `run`, `runner.rs`, `RunId`, `Runner`, `.new`, `preflight.rs`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
...
- **Should `0. Estándares obligatorios — INLINE, no referenciados` be split into smaller, more focused modules?**
