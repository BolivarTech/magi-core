...
Generate content for section `section-01-errors` (filename: `section-01-errors.md`).
...
for `section-01-errors` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-01-errors.md`
