...
Generate content for section `section-10-claude-cli` (filename: `section-10-claude-cli.md`).
...
for `section-10-claude-cli` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-10-claude-cli.md`
