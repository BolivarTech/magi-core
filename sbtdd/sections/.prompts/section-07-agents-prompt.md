...
Generate content for section `section-07-agents` (filename: `section-07-agents.md`).
...
for `section-07-agents` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-07-agents.md`
