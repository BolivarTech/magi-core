...
Generate content for section `section-12-example` (filename: `section-12-example.md`).
...
for `section-12-example` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-12-example.md`
