...
Generate content for section `section-11-prelude` (filename: `section-11-prelude.md`).
...
for `section-11-prelude` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-11-prelude.md`
