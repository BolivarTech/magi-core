...
Generate content for section `section-03-validation` (filename: `section-03-validation.md`).
...
for `section-03-validation` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-03-validation.md`
