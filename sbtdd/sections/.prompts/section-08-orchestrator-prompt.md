...
Generate content for section `section-08-orchestrator` (filename: `section-08-orchestrator.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `D:\jbolivarg\RustProjects\MAGI\sbtdd/claude-plan.md` - Full implementation plan
2. `D:\jbolivarg\RustProjects\MAGI\sbtdd/claude-plan-tdd.md` - Test stubs for each section
3. `D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-08-orchestrator` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-08-orchestrator.md`
