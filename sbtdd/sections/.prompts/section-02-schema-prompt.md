...
Generate content for section `section-02-schema` (filename: `section-02-schema.md`).
...
for `section-02-schema` to understand what this section should contain.
...
`D:\jbolivarg\RustProjects\MAGI\sbtdd/sections/section-02-schema.md`
